...
WHEN URXUP8 IS NOT NULL THEN SAFE_CAST(URXUP8 AS FLOAT64)WHEN URXUP8 IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXNO3 IS NOT NULL THEN SAFE_CAST(URXNO3 AS FLOAT64)WHEN URXNO3 IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXSCN IS NOT NULL THEN SAFE_CAST(URXSCN AS FLOAT64)WHEN URXSCN IS NULL THEN NULL 
ELSE NULL 
