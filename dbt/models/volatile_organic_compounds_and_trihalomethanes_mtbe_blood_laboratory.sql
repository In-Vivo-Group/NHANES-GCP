...
WHEN WTSVOC2Y IS NOT NULL THEN SAFE_CAST(WTSVOC2Y AS FLOAT64)WHEN WTSVOC2Y IS NULL THEN NULL 
ELSE NULL 
 END as voc_subsample_weight,
WHEN LBX2DF IS NOT NULL THEN SAFE_CAST(LBX2DF AS FLOAT64)WHEN LBX2DF IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV06 IS NOT NULL THEN SAFE_CAST(LBXV06 AS FLOAT64)WHEN LBXV06 IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV07N IS NOT NULL THEN SAFE_CAST(LBXV07N AS FLOAT64)WHEN LBXV07N IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV08N IS NOT NULL THEN SAFE_CAST(LBXV08N AS FLOAT64)WHEN LBXV08N IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV1D IS NOT NULL THEN SAFE_CAST(LBXV1D AS FLOAT64)WHEN LBXV1D IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV2A IS NOT NULL THEN SAFE_CAST(LBXV2A AS FLOAT64)WHEN LBXV2A IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV3B IS NOT NULL THEN SAFE_CAST(LBXV3B AS FLOAT64)WHEN LBXV3B IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXV4C IS NOT NULL THEN SAFE_CAST(LBXV4C AS FLOAT64)WHEN LBXV4C IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVBF IS NOT NULL THEN SAFE_CAST(LBXVBF AS FLOAT64)WHEN LBXVBF IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVBM IS NOT NULL THEN SAFE_CAST(LBXVBM AS FLOAT64)WHEN LBXVBM IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVBZ IS NOT NULL THEN SAFE_CAST(LBXVBZ AS FLOAT64)WHEN LBXVBZ IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVBZN IS NOT NULL THEN SAFE_CAST(LBXVBZN AS FLOAT64)WHEN LBXVBZN IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVC6 IS NOT NULL THEN SAFE_CAST(LBXVC6 AS FLOAT64)WHEN LBXVC6 IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVCB IS NOT NULL THEN SAFE_CAST(LBXVCB AS FLOAT64)WHEN LBXVCB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVCF IS NOT NULL THEN SAFE_CAST(LBXVCF AS FLOAT64)WHEN LBXVCF IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVCM IS NOT NULL THEN SAFE_CAST(LBXVCM AS FLOAT64)WHEN LBXVCM IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVCT IS NOT NULL THEN SAFE_CAST(LBXVCT AS FLOAT64)WHEN LBXVCT IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVDB IS NOT NULL THEN SAFE_CAST(LBXVDB AS FLOAT64)WHEN LBXVDB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVDEE IS NOT NULL THEN SAFE_CAST(LBXVDEE AS FLOAT64)WHEN LBXVDEE IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVEA IS NOT NULL THEN SAFE_CAST(LBXVEA AS FLOAT64)WHEN LBXVEA IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVEB IS NOT NULL THEN SAFE_CAST(LBXVEB AS FLOAT64)WHEN LBXVEB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVEC IS NOT NULL THEN SAFE_CAST(LBXVEC AS FLOAT64)WHEN LBXVEC IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVFN IS NOT NULL THEN SAFE_CAST(LBXVFN AS FLOAT64)WHEN LBXVFN IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVIBN IS NOT NULL THEN SAFE_CAST(LBXVIBN AS FLOAT64)WHEN LBXVIBN IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVIPB IS NOT NULL THEN SAFE_CAST(LBXVIPB AS FLOAT64)WHEN LBXVIPB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVMC IS NOT NULL THEN SAFE_CAST(LBXVMC AS FLOAT64)WHEN LBXVMC IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVME IS NOT NULL THEN SAFE_CAST(LBXVME AS FLOAT64)WHEN LBXVME IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVMCP IS NOT NULL THEN SAFE_CAST(LBXVMCP AS FLOAT64)WHEN LBXVMCP IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVMIK IS NOT NULL THEN SAFE_CAST(LBXVMIK AS FLOAT64)WHEN LBXVMIK IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVNB IS NOT NULL THEN SAFE_CAST(LBXVNB AS FLOAT64)WHEN LBXVNB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVOX IS NOT NULL THEN SAFE_CAST(LBXVOX AS FLOAT64)WHEN LBXVOX IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVTC IS NOT NULL THEN SAFE_CAST(LBXVTC AS FLOAT64)WHEN LBXVTC IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVTE IS NOT NULL THEN SAFE_CAST(LBXVTE AS FLOAT64)WHEN LBXVTE IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVTFT IS NOT NULL THEN SAFE_CAST(LBXVTFT AS FLOAT64)WHEN LBXVTFT IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVTHF IS NOT NULL THEN SAFE_CAST(LBXVTHF AS FLOAT64)WHEN LBXVTHF IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVTP IS NOT NULL THEN SAFE_CAST(LBXVTP AS FLOAT64)WHEN LBXVTP IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVVB IS NOT NULL THEN SAFE_CAST(LBXVVB AS FLOAT64)WHEN LBXVVB IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXVXY IS NOT NULL THEN SAFE_CAST(LBXVXY AS FLOAT64)WHEN LBXVXY IS NULL THEN NULL 
ELSE NULL 
