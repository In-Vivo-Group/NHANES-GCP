...
AUQ055 as AUQ055, -- Could not automatically decode
CASE
...
AUQ395 as AUQ395, -- Could not automatically decode
CASE
...
CASE
    WHEN AUQ149a = 1 THEN 'A hearing aid' 
WHEN AUQ149a = 7 THEN 'Refused' 
WHEN AUQ149a = 9 THEN 'Don't know' 
WHEN AUQ149a IS NULL THEN NULL 
ELSE NULL 
 END as now_use_a_hearing_aid,
CASE
    WHEN AUQ149b = 2 THEN 'A personal sound amplifier' 
WHEN AUQ149b IS NULL THEN NULL 
ELSE NULL 
 END as now_use_a_personal_sound_amplifier,
CASE
    WHEN AUQ149c = 3 THEN 'A Cochlear implant' 
...
AUQ435 as AUQ435, -- Could not automatically decode
CASE
