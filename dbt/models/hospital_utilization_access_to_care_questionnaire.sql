...
WHEN HUQ041 = 6 THEN 'Doesn't go to one place most often' 
WHEN HUQ041 = 77 THEN 'Refused' 
WHEN HUQ041 = 99 THEN 'Don't know' 
...
WHEN HUQ051 = 99 THEN 'Don't know' 
...
WHEN HUQ061 = 99 THEN 'Don't know' 
