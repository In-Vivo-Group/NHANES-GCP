...
WHEN OCD150 = 9 THEN 'Don't know' 
WHEN OCD150 IS NULL THEN NULL 
ELSE NULL 
 END as type_of_work_done_last_week,
WHEN OCQ180 IS NOT NULL THEN SAFE_CAST(OCQ180 AS FLOAT64)WHEN OCQ180 IS NULL THEN NULL 
ELSE NULL 
...
WHEN OCQ260 = 99 THEN 'Don't know' 
WHEN OCQ260 IS NULL THEN NULL 
ELSE NULL 
 END as description_of_job_work_situation,
WHEN OCD270 IS NOT NULL THEN SAFE_CAST(OCD270 AS FLOAT64)WHEN OCD270 IS NULL THEN NULL 
ELSE NULL 
...
WHEN OCQ380 = 99 THEN 'Don't know' 
...
WHEN OCD390G = 9 THEN 'Don't know' 
WHEN OCD390G IS NULL THEN NULL 
ELSE NULL 
 END as kind_of_work_you_have_done_the_longest,
WHEN OCD395 IS NOT NULL THEN SAFE_CAST(OCD395 AS FLOAT64)WHEN OCD395 IS NULL THEN NULL 
ELSE NULL 
