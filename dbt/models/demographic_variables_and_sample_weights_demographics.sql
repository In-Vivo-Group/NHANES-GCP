...
ELSE NULL 
 END as gender,
WHEN RIDAGEYR IS NOT NULL THEN SAFE_CAST(RIDAGEYR AS FLOAT64)WHEN RIDAGEYR IS NULL THEN NULL 
ELSE NULL 
 END as age_in_years_at_screening,
WHEN RIDAGEMN IS NOT NULL THEN SAFE_CAST(RIDAGEMN AS FLOAT64)WHEN RIDAGEMN IS NULL THEN NULL 
ELSE NULL 
...
WHEN RIDEXAGM IS NOT NULL THEN SAFE_CAST(RIDEXAGM AS FLOAT64)WHEN RIDEXAGM IS NULL THEN NULL 
ELSE NULL 
...
WHEN WTINT2YR IS NOT NULL THEN SAFE_CAST(WTINT2YR AS FLOAT64)WHEN WTINT2YR IS NULL THEN NULL 
ELSE NULL 
 END as full_sample_2_year_interview_weight,
WHEN WTMEC2YR IS NOT NULL THEN SAFE_CAST(WTMEC2YR AS FLOAT64)WHEN WTMEC2YR IS NULL THEN NULL 
ELSE NULL 
 END as full_sample_2_year_mec_exam_weight,
WHEN SDMVPSU IS NOT NULL THEN SAFE_CAST(SDMVPSU AS FLOAT64)WHEN SDMVPSU IS NULL THEN NULL 
ELSE NULL 
 END as masked_variance_pseudo_psu,
WHEN SDMVSTRA IS NOT NULL THEN SAFE_CAST(SDMVSTRA AS FLOAT64)WHEN SDMVSTRA IS NULL THEN NULL 
ELSE NULL 
...
WHEN INDFMPIR IS NOT NULL THEN SAFE_CAST(INDFMPIR AS FLOAT64)WHEN INDFMPIR IS NULL THEN NULL 
ELSE NULL 
