...
WHEN SMD030 IS NOT NULL THEN SAFE_CAST(SMD030 AS FLOAT64)WHEN SMD030 IS NULL THEN NULL 
ELSE NULL 
...
WHEN SMQ050Q IS NOT NULL THEN SAFE_CAST(SMQ050Q AS FLOAT64)WHEN SMQ050Q IS NULL THEN NULL 
ELSE NULL 
...
WHEN SMD057 IS NOT NULL THEN SAFE_CAST(SMD057 AS FLOAT64)WHEN SMD057 IS NULL THEN NULL 
ELSE NULL 
...
WHEN SMD641 IS NOT NULL THEN SAFE_CAST(SMD641 AS FLOAT64)WHEN SMD641 IS NULL THEN NULL 
ELSE NULL 
 END as days_smoked_cigs_during_past_30_days,
WHEN SMD650 IS NOT NULL THEN SAFE_CAST(SMD650 AS FLOAT64)WHEN SMD650 IS NULL THEN NULL 
ELSE NULL 
...
WHEN SMD100TR IS NOT NULL THEN SAFE_CAST(SMD100TR AS FLOAT64)WHEN SMD100TR IS NULL THEN NULL 
ELSE NULL 
 END as ftc_tar_content,
WHEN SMD100NI IS NOT NULL THEN SAFE_CAST(SMD100NI AS FLOAT64)WHEN SMD100NI IS NULL THEN NULL 
ELSE NULL 
 END as ftc_nicotine_content,
WHEN SMD100CO IS NOT NULL THEN SAFE_CAST(SMD100CO AS FLOAT64)WHEN SMD100CO IS NULL THEN NULL 
ELSE NULL 
...
WHEN SMD630 IS NOT NULL THEN SAFE_CAST(SMD630 AS FLOAT64)WHEN SMD630 IS NULL THEN NULL 
ELSE NULL 
