...
WHEN PFQ061A = 9 THEN 'Don't know' 
...
WHEN PFQ061B = 9 THEN 'Don't know' 
...
WHEN PFQ061C = 9 THEN 'Don't know' 
...
WHEN PFQ061D = 9 THEN 'Don't know' 
...
WHEN PFQ061E = 9 THEN 'Don't know' 
...
WHEN PFQ061F = 9 THEN 'Don't know' 
...
WHEN PFQ061G = 9 THEN 'Don't know' 
...
WHEN PFQ061H = 9 THEN 'Don't know' 
...
WHEN PFQ061I = 9 THEN 'Don't know' 
...
WHEN PFQ061J = 9 THEN 'Don't know' 
...
WHEN PFQ061K = 9 THEN 'Don't know' 
...
WHEN PFQ061L = 9 THEN 'Don't know' 
...
WHEN PFQ061M = 9 THEN 'Don't know' 
...
WHEN PFQ061N = 9 THEN 'Don't know' 
...
WHEN PFQ061O = 9 THEN 'Don't know' 
...
WHEN PFQ061P = 9 THEN 'Don't know' 
...
WHEN PFQ061Q = 9 THEN 'Don't know' 
...
WHEN PFQ061R = 9 THEN 'Don't know' 
...
WHEN PFQ061S = 9 THEN 'Don't know' 
...
WHEN PFQ061T = 9 THEN 'Don't know' 
WHEN PFQ061T IS NULL THEN NULL 
ELSE NULL 
 END as difficulty_moving_large_objects,
PFQ066A as PFQ066A, -- Could not automatically decode
CASE
...
WHEN PFQ063A = 99 THEN 'Don't know' 
...
WHEN PFQ063B = 99 THEN 'Don't know' 
...
WHEN PFQ063C = 99 THEN 'Don't know' 
...
WHEN PFQ063D = 99 THEN 'Don't know' 
...
WHEN PFQ063E = 99 THEN 'Don't know' 
