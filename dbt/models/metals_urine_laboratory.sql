...
WHEN URXUBA IS NOT NULL THEN SAFE_CAST(URXUBA AS FLOAT64)WHEN URXUBA IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUCD IS NOT NULL THEN SAFE_CAST(URXUCD AS FLOAT64)WHEN URXUCD IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUCO IS NOT NULL THEN SAFE_CAST(URXUCO AS FLOAT64)WHEN URXUCO IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUCS IS NOT NULL THEN SAFE_CAST(URXUCS AS FLOAT64)WHEN URXUCS IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUMO IS NOT NULL THEN SAFE_CAST(URXUMO AS FLOAT64)WHEN URXUMO IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUPB IS NOT NULL THEN SAFE_CAST(URXUPB AS FLOAT64)WHEN URXUPB IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUSB IS NOT NULL THEN SAFE_CAST(URXUSB AS FLOAT64)WHEN URXUSB IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUTL IS NOT NULL THEN SAFE_CAST(URXUTL AS FLOAT64)WHEN URXUTL IS NULL THEN NULL 
ELSE NULL 
...
WHEN URXUTU IS NOT NULL THEN SAFE_CAST(URXUTU AS FLOAT64)WHEN URXUTU IS NULL THEN NULL 
ELSE NULL 
