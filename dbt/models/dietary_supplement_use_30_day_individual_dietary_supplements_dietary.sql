...
WHEN DSD090 IS NOT NULL THEN SAFE_CAST(DSD090 AS FLOAT64)WHEN DSD090 IS NULL THEN NULL 
ELSE NULL 
 END as how_long_supplement_taken_days,
WHEN DSD103 IS NOT NULL THEN SAFE_CAST(DSD103 AS FLOAT64)WHEN DSD103 IS NULL THEN NULL 
ELSE NULL 
 END as days_supplement_taken_past_30_days,
WHEN DSD122Q IS NOT NULL THEN SAFE_CAST(DSD122Q AS FLOAT64)WHEN DSD122Q IS NULL THEN NULL 
ELSE NULL 
...
ELSE NULL 
 END as dosage_form,
WHEN DSDACTSS IS NOT NULL THEN SAFE_CAST(DSDACTSS AS FLOAT64)WHEN DSDACTSS IS NULL THEN NULL 
ELSE NULL 
...
WHEN DSQIKCAL IS NOT NULL THEN SAFE_CAST(DSQIKCAL AS FLOAT64)WHEN DSQIKCAL IS NULL THEN NULL 
ELSE NULL 
 END as energy_kcal,
WHEN DSQIPROT IS NOT NULL THEN SAFE_CAST(DSQIPROT AS FLOAT64)WHEN DSQIPROT IS NULL THEN NULL 
ELSE NULL 
 END as protein_gm,
WHEN DSQICARB IS NOT NULL THEN SAFE_CAST(DSQICARB AS FLOAT64)WHEN DSQICARB IS NULL THEN NULL 
ELSE NULL 
 END as carbohydrate_gm,
WHEN DSQISUGR IS NOT NULL THEN SAFE_CAST(DSQISUGR AS FLOAT64)WHEN DSQISUGR IS NULL THEN NULL 
ELSE NULL 
 END as total_sugars_gm,
WHEN DSQIFIBE IS NOT NULL THEN SAFE_CAST(DSQIFIBE AS FLOAT64)WHEN DSQIFIBE IS NULL THEN NULL 
ELSE NULL 
 END as dietary_fiber_gm,
WHEN DSQITFAT IS NOT NULL THEN SAFE_CAST(DSQITFAT AS FLOAT64)WHEN DSQITFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_fat_gm,
WHEN DSQISFAT IS NOT NULL THEN SAFE_CAST(DSQISFAT AS FLOAT64)WHEN DSQISFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_saturated_fatty_acids_gm,
WHEN DSQIMFAT IS NOT NULL THEN SAFE_CAST(DSQIMFAT AS FLOAT64)WHEN DSQIMFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_monounsaturated_fatty_acids_gm,
WHEN DSQIPFAT IS NOT NULL THEN SAFE_CAST(DSQIPFAT AS FLOAT64)WHEN DSQIPFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_polyunsaturated_fatty_acids_gm,
WHEN DSQICHOL IS NOT NULL THEN SAFE_CAST(DSQICHOL AS FLOAT64)WHEN DSQICHOL IS NULL THEN NULL 
ELSE NULL 
 END as cholesterol_mg,
WHEN DSQILYCO IS NOT NULL THEN SAFE_CAST(DSQILYCO AS FLOAT64)WHEN DSQILYCO IS NULL THEN NULL 
ELSE NULL 
 END as lycopene_mcg,
WHEN DSQILZ IS NOT NULL THEN SAFE_CAST(DSQILZ AS FLOAT64)WHEN DSQILZ IS NULL THEN NULL 
ELSE NULL 
 END as lutein_zeaxanthin_mcg,
WHEN DSQIVB1 IS NOT NULL THEN SAFE_CAST(DSQIVB1 AS FLOAT64)WHEN DSQIVB1 IS NULL THEN NULL 
ELSE NULL 
 END as thiamin_vitamin_b1_mg,
WHEN DSQIVB2 IS NOT NULL THEN SAFE_CAST(DSQIVB2 AS FLOAT64)WHEN DSQIVB2 IS NULL THEN NULL 
ELSE NULL 
 END as riboflavin_vitamin_b2_mg,
WHEN DSQINIAC IS NOT NULL THEN SAFE_CAST(DSQINIAC AS FLOAT64)WHEN DSQINIAC IS NULL THEN NULL 
ELSE NULL 
 END as niacin_mg,
WHEN DSQIVB6 IS NOT NULL THEN SAFE_CAST(DSQIVB6 AS FLOAT64)WHEN DSQIVB6 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b6_mg,
WHEN DSQIFA IS NOT NULL THEN SAFE_CAST(DSQIFA AS FLOAT64)WHEN DSQIFA IS NULL THEN NULL 
ELSE NULL 
 END as folic_acid_mcg,
WHEN DSQIFDFE IS NOT NULL THEN SAFE_CAST(DSQIFDFE AS FLOAT64)WHEN DSQIFDFE IS NULL THEN NULL 
ELSE NULL 
 END as folate_dfe_mcg,
WHEN DSQICHL IS NOT NULL THEN SAFE_CAST(DSQICHL AS FLOAT64)WHEN DSQICHL IS NULL THEN NULL 
ELSE NULL 
 END as total_choline_mg,
WHEN DSQIVB12 IS NOT NULL THEN SAFE_CAST(DSQIVB12 AS FLOAT64)WHEN DSQIVB12 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b12_mcg,
WHEN DSQIVC IS NOT NULL THEN SAFE_CAST(DSQIVC AS FLOAT64)WHEN DSQIVC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_c_mg,
WHEN DSQIVK IS NOT NULL THEN SAFE_CAST(DSQIVK AS FLOAT64)WHEN DSQIVK IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_k_mcg,
WHEN DSQIVD IS NOT NULL THEN SAFE_CAST(DSQIVD AS FLOAT64)WHEN DSQIVD IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_d_d2_d3_mcg,
WHEN DSQICALC IS NOT NULL THEN SAFE_CAST(DSQICALC AS FLOAT64)WHEN DSQICALC IS NULL THEN NULL 
ELSE NULL 
 END as calcium_mg,
WHEN DSQIPHOS IS NOT NULL THEN SAFE_CAST(DSQIPHOS AS FLOAT64)WHEN DSQIPHOS IS NULL THEN NULL 
ELSE NULL 
 END as phosphorus_mg,
WHEN DSQIMAGN IS NOT NULL THEN SAFE_CAST(DSQIMAGN AS FLOAT64)WHEN DSQIMAGN IS NULL THEN NULL 
ELSE NULL 
 END as magnesium_mg,
WHEN DSQIIRON IS NOT NULL THEN SAFE_CAST(DSQIIRON AS FLOAT64)WHEN DSQIIRON IS NULL THEN NULL 
ELSE NULL 
 END as iron_mg,
WHEN DSQIZINC IS NOT NULL THEN SAFE_CAST(DSQIZINC AS FLOAT64)WHEN DSQIZINC IS NULL THEN NULL 
ELSE NULL 
 END as zinc_mg,
WHEN DSQICOPP IS NOT NULL THEN SAFE_CAST(DSQICOPP AS FLOAT64)WHEN DSQICOPP IS NULL THEN NULL 
ELSE NULL 
 END as copper_mg,
WHEN DSQISODI IS NOT NULL THEN SAFE_CAST(DSQISODI AS FLOAT64)WHEN DSQISODI IS NULL THEN NULL 
ELSE NULL 
 END as sodium_mg,
WHEN DSQIPOTA IS NOT NULL THEN SAFE_CAST(DSQIPOTA AS FLOAT64)WHEN DSQIPOTA IS NULL THEN NULL 
ELSE NULL 
 END as potassium_mg,
WHEN DSQISELE IS NOT NULL THEN SAFE_CAST(DSQISELE AS FLOAT64)WHEN DSQISELE IS NULL THEN NULL 
ELSE NULL 
 END as selenium_mcg,
WHEN DSQICAFF IS NOT NULL THEN SAFE_CAST(DSQICAFF AS FLOAT64)WHEN DSQICAFF IS NULL THEN NULL 
ELSE NULL 
 END as caffeine_mg,
