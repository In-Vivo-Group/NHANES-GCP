...
WHEN LBXIHG IS NOT NULL THEN SAFE_CAST(LBXIHG AS FLOAT64)WHEN LBXIHG IS NULL THEN NULL 
ELSE NULL 
 END as mercury_inorganic_ug_l,
WHEN LBDIHGSI IS NOT NULL THEN SAFE_CAST(LBDIHGSI AS FLOAT64)WHEN LBDIHGSI IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXBGE IS NOT NULL THEN SAFE_CAST(LBXBGE AS FLOAT64)WHEN LBXBGE IS NULL THEN NULL 
ELSE NULL 
...
WHEN LBXBGM IS NOT NULL THEN SAFE_CAST(LBXBGM AS FLOAT64)WHEN LBXBGM IS NULL THEN NULL 
ELSE NULL 
