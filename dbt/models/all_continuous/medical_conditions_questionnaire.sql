...
WHEN MCQ149 = '9' THEN 'Dont know' 
WHEN MCQ149 IS NULL THEN NULL 
ELSE NULL 
 END as menstrual_periods_started_yet, 

CASE
        WHEN MCQ151 IS NOT NULL THEN SAFE_CAST(MCQ151 AS FLOAT64) 
WHEN MCQ151 IS NOT NULL THEN SAFE_CAST(MCQ151 AS FLOAT64) 
WHEN MCQ151 IS NOT NULL THEN SAFE_CAST(MCQ151 AS FLOAT64) 
...
WHEN MCQ560 = '9' THEN 'Dont know' 
WHEN MCQ560 IS NULL THEN NULL 
ELSE NULL 
 END as ever_had_gallbladder_surgery, 

CASE
        WHEN MCQ570 IS NOT NULL THEN SAFE_CAST(MCQ570 AS FLOAT64) 
WHEN MCQ570 IS NOT NULL THEN SAFE_CAST(MCQ570 AS FLOAT64) 
WHEN MCQ570 IS NOT NULL THEN SAFE_CAST(MCQ570 AS FLOAT64) 
WHEN MCQ570 IS NOT NULL THEN SAFE_CAST(MCQ570 AS FLOAT64) 
...
WHEN MCQ203 = '9' THEN 'Dont know' 
WHEN MCQ203 IS NULL THEN NULL 
ELSE NULL 
 END as ever_been_told_you_have_jaundice, 

CASE
        WHEN MCQ206 IS NOT NULL THEN SAFE_CAST(MCQ206 AS FLOAT64) 
WHEN MCQ206 IS NOT NULL THEN SAFE_CAST(MCQ206 AS FLOAT64) 
WHEN MCQ206 IS NOT NULL THEN SAFE_CAST(MCQ206 AS FLOAT64) 
WHEN MCQ206 IS NOT NULL THEN SAFE_CAST(MCQ206 AS FLOAT64) 
