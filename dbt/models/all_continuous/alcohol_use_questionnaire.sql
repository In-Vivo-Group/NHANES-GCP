...
WHEN ALQ151 = '9' THEN 'Dont know' 
WHEN ALQ151 IS NULL THEN NULL 
ELSE NULL 
 END as ever_have_4_5_or_more_drinks_every_day, 

CASE
        WHEN ALQ170 IS NOT NULL THEN SAFE_CAST(ALQ170 AS FLOAT64) 
WHEN ALQ170 IS NOT NULL THEN SAFE_CAST(ALQ170 AS FLOAT64) 
WHEN ALQ170 IS NOT NULL THEN SAFE_CAST(ALQ170 AS FLOAT64) 
WHEN ALQ170 IS NOT NULL THEN SAFE_CAST(ALQ170 AS FLOAT64) 
