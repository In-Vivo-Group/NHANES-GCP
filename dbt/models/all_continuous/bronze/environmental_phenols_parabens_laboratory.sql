...
doc_file_url,
dataset,
 FROM {{ ref('stg_environmental_phenols_parabens_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/EPH_G.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/EPH_D.htm
*/
