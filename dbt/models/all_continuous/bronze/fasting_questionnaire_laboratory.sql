...
ELSE SAFE_CAST(PHACOFHR AS FLOAT64) 
 END as coffee_tea_fast_time_hours, 

CASE
WHEN PHACOFMN IS NULL THEN NULL 
ELSE SAFE_CAST(PHACOFMN AS FLOAT64) 
...
ELSE SAFE_CAST(PHAALCHR AS FLOAT64) 
 END as alcohol_fast_time_hours, 

CASE
WHEN PHAALCMN IS NULL THEN NULL 
ELSE SAFE_CAST(PHAALCMN AS FLOAT64) 
