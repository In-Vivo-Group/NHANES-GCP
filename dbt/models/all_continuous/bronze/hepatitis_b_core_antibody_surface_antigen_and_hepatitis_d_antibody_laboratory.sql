...
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBXHBC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Indeterminate' -- categorize numeric values
...
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBDHBG AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Indeterminate' -- categorize numeric values
...
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBDHD AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Indeterminate' -- categorize numeric values
WHEN LBDHD IS NULL THEN NULL 
ELSE SAFE_CAST(LBDHD AS STRING) 
 END as hepatitis_d_antibody_anti_hdv, 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_HEPBD.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/HEPBD_I.htm
