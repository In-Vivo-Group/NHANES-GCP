...
CASE
            WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXSEAR,'.0','') AS INT64) AS STRING) = '1' THEN 'Right Ear' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXSEAR,'.0','') AS INT64) AS STRING) = '2' THEN 'Left Ear' -- categorize string values 
WHEN RFXSEAR IS NULL THEN NULL 
ELSE SAFE_CAST(RFXSEAR AS STRING) 
 END as ear_tested, 

CASE
            WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '1' THEN '85 dB and 1 kHz' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '5' THEN '95 dB and 1 kHz' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '9' THEN '105 dB and 1 kHz' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '10' THEN '85 dB and 2 kHz' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '14' THEN '95 dB and 2 kHz' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXLEVEL,'.0','') AS INT64) AS STRING) = '18' THEN '105 dB and 2 kHz' -- categorize string values 
WHEN RFXLEVEL IS NULL THEN NULL 
ELSE SAFE_CAST(RFXLEVEL AS STRING) 
 END as sound_stimulus_level, 

CASE
            WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXRFXDC,'.0','') AS INT64) AS STRING) = '0' THEN 'False' -- categorize string values 
WHEN SAFE_CAST(SAFE_CAST(REPLACE(RFXRFXDC,'.0','') AS INT64) AS STRING) = '1' THEN 'True' -- categorize string values 
