...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(WBXFEAR AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Right Ear' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(WBXFEAR AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'Left Ear' -- categorize numeric values
