...
WHEN AUQ570 = '9' THEN 'Dont know' 
WHEN AUQ570 IS NULL THEN NULL 
ELSE NULL 
 END as listened_to_loud_sound_yesterday, 

CASE
        WHEN AUQ580 IS NOT NULL THEN SAFE_CAST(AUQ580 AS FLOAT64) 
WHEN AUQ580 IS NOT NULL THEN SAFE_CAST(AUQ580 AS FLOAT64) 
WHEN AUQ580 IS NOT NULL THEN SAFE_CAST(AUQ580 AS FLOAT64) 
...
WHEN AUQ600 = '9' THEN 'Dont know' 
WHEN AUQ600 IS NULL THEN NULL 
ELSE NULL 
 END as listened_to_music_w_earphones_yesterday, 

CASE
        WHEN AUQ610 IS NOT NULL THEN SAFE_CAST(AUQ610 AS FLOAT64) 
WHEN AUQ610 IS NOT NULL THEN SAFE_CAST(AUQ610 AS FLOAT64) 
WHEN AUQ610 IS NOT NULL THEN SAFE_CAST(AUQ610 AS FLOAT64) 
...
WHEN AUQ051 = '9' THEN 'No / dont know' 
...
WHEN AUQ031 = '9' THEN 'Dont know' 
WHEN AUQ031 IS NULL THEN NULL 
ELSE NULL 
 END as exposed_to_loud_noise_last_24_hrs, 

CASE
        WHEN AUQ041 IS NOT NULL THEN SAFE_CAST(AUQ041 AS FLOAT64) 
WHEN AUQ041 IS NOT NULL THEN SAFE_CAST(AUQ041 AS FLOAT64) 
WHEN AUQ041 IS NOT NULL THEN SAFE_CAST(AUQ041 AS FLOAT64) 
...
WHEN AUQ520 = '9' THEN 'Dont know' 
WHEN AUQ520 IS NULL THEN NULL 
ELSE NULL 
 END as listened_to_music_w_earphone_last_24_hrs, 

CASE
        WHEN AUQ530 IS NOT NULL THEN SAFE_CAST(AUQ530 AS FLOAT64) 
WHEN AUQ530 IS NOT NULL THEN SAFE_CAST(AUQ530 AS FLOAT64) 
WHEN AUQ530 IS NOT NULL THEN SAFE_CAST(AUQ530 AS FLOAT64) 
...
WHEN AUQ050 = 9 THEN 'No / dont know' 
...
CASE
        WHEN AUXU1K1R IS NOT NULL THEN AUXU1K1R 
WHEN AUXU1K1R IS NOT NULL THEN AUXU1K1R 
WHEN AUXU1K1R IS NOT NULL THEN AUXU1K1R 
...
CASE
        WHEN AUXU500R IS NOT NULL THEN AUXU500R 
WHEN AUXU500R IS NOT NULL THEN AUXU500R 
WHEN AUXU500R IS NOT NULL THEN AUXU500R 
...
CASE
        WHEN AUXU1K2R IS NOT NULL THEN AUXU1K2R 
WHEN AUXU1K2R IS NOT NULL THEN AUXU1K2R 
WHEN AUXU1K2R IS NOT NULL THEN AUXU1K2R 
...
CASE
        WHEN AUXU2KR IS NOT NULL THEN AUXU2KR 
WHEN AUXU2KR IS NOT NULL THEN AUXU2KR 
WHEN AUXU2KR IS NOT NULL THEN AUXU2KR 
...
CASE
        WHEN AUXU3KR IS NOT NULL THEN AUXU3KR 
WHEN AUXU3KR IS NOT NULL THEN AUXU3KR 
WHEN AUXU3KR IS NOT NULL THEN AUXU3KR 
...
CASE
        WHEN AUXU4KR IS NOT NULL THEN AUXU4KR 
WHEN AUXU4KR IS NOT NULL THEN AUXU4KR 
WHEN AUXU4KR IS NOT NULL THEN AUXU4KR 
...
CASE
        WHEN AUXU6KR IS NOT NULL THEN AUXU6KR 
WHEN AUXU6KR IS NOT NULL THEN AUXU6KR 
WHEN AUXU6KR IS NOT NULL THEN AUXU6KR 
...
CASE
        WHEN AUXU8KR IS NOT NULL THEN AUXU8KR 
WHEN AUXU8KR IS NOT NULL THEN AUXU8KR 
WHEN AUXU8KR IS NOT NULL THEN AUXU8KR 
...
CASE
        WHEN AUXU1K1L IS NOT NULL THEN AUXU1K1L 
WHEN AUXU1K1L IS NOT NULL THEN AUXU1K1L 
WHEN AUXU1K1L IS NOT NULL THEN AUXU1K1L 
...
CASE
        WHEN AUXU500L IS NOT NULL THEN AUXU500L 
WHEN AUXU500L IS NOT NULL THEN AUXU500L 
WHEN AUXU500L IS NOT NULL THEN AUXU500L 
...
CASE
        WHEN AUXU1K2L IS NOT NULL THEN AUXU1K2L 
WHEN AUXU1K2L IS NOT NULL THEN AUXU1K2L 
WHEN AUXU1K2L IS NOT NULL THEN AUXU1K2L 
...
CASE
        WHEN AUXU2KL IS NOT NULL THEN AUXU2KL 
WHEN AUXU2KL IS NOT NULL THEN AUXU2KL 
WHEN AUXU2KL IS NOT NULL THEN AUXU2KL 
...
CASE
        WHEN AUXU3KL IS NOT NULL THEN AUXU3KL 
WHEN AUXU3KL IS NOT NULL THEN AUXU3KL 
WHEN AUXU3KL IS NOT NULL THEN AUXU3KL 
...
CASE
        WHEN AUXU4KL IS NOT NULL THEN AUXU4KL 
WHEN AUXU4KL IS NOT NULL THEN AUXU4KL 
WHEN AUXU4KL IS NOT NULL THEN AUXU4KL 
...
CASE
        WHEN AUXU6KL IS NOT NULL THEN AUXU6KL 
WHEN AUXU6KL IS NOT NULL THEN AUXU6KL 
WHEN AUXU6KL IS NOT NULL THEN AUXU6KL 
...
CASE
        WHEN AUXU8KL IS NOT NULL THEN AUXU8KL 
WHEN AUXU8KL IS NOT NULL THEN AUXU8KL 
WHEN AUXU8KL IS NOT NULL THEN AUXU8KL 
...
CASE
        WHEN AUXR1K1R IS NOT NULL THEN AUXR1K1R 
WHEN AUXR1K1R IS NOT NULL THEN AUXR1K1R 
WHEN AUXR1K1R IS NOT NULL THEN AUXR1K1R 
...
CASE
        WHEN AUXR5CR IS NOT NULL THEN AUXR5CR 
WHEN AUXR5CR IS NOT NULL THEN AUXR5CR 
WHEN AUXR5CR IS NOT NULL THEN AUXR5CR 
...
CASE
        WHEN AUXR1K2R IS NOT NULL THEN AUXR1K2R 
WHEN AUXR1K2R IS NOT NULL THEN AUXR1K2R 
WHEN AUXR1K2R IS NOT NULL THEN AUXR1K2R 
...
CASE
        WHEN AUXR2KR IS NOT NULL THEN AUXR2KR 
WHEN AUXR2KR IS NOT NULL THEN AUXR2KR 
WHEN AUXR2KR IS NOT NULL THEN AUXR2KR 
...
CASE
        WHEN AUXR3KR IS NOT NULL THEN AUXR3KR 
WHEN AUXR3KR IS NOT NULL THEN AUXR3KR 
WHEN AUXR3KR IS NOT NULL THEN AUXR3KR 
...
CASE
        WHEN AUXR4KR IS NOT NULL THEN AUXR4KR 
WHEN AUXR4KR IS NOT NULL THEN AUXR4KR 
WHEN AUXR4KR IS NOT NULL THEN AUXR4KR 
...
CASE
        WHEN AUXR6KR IS NOT NULL THEN AUXR6KR 
WHEN AUXR6KR IS NOT NULL THEN AUXR6KR 
WHEN AUXR6KR IS NOT NULL THEN AUXR6KR 
...
CASE
        WHEN AUXR8KR IS NOT NULL THEN AUXR8KR 
WHEN AUXR8KR IS NOT NULL THEN AUXR8KR 
WHEN AUXR8KR IS NOT NULL THEN AUXR8KR 
...
CASE
        WHEN AUXR1K1L IS NOT NULL THEN AUXR1K1L 
WHEN AUXR1K1L IS NOT NULL THEN AUXR1K1L 
WHEN AUXR1K1L IS NOT NULL THEN AUXR1K1L 
...
CASE
        WHEN AUXR5CL IS NOT NULL THEN AUXR5CL 
WHEN AUXR5CL IS NOT NULL THEN AUXR5CL 
WHEN AUXR5CL IS NOT NULL THEN AUXR5CL 
...
CASE
        WHEN AUXR1K2L IS NOT NULL THEN AUXR1K2L 
WHEN AUXR1K2L IS NOT NULL THEN AUXR1K2L 
WHEN AUXR1K2L IS NOT NULL THEN AUXR1K2L 
...
CASE
        WHEN AUXR2KL IS NOT NULL THEN AUXR2KL 
WHEN AUXR2KL IS NOT NULL THEN AUXR2KL 
WHEN AUXR2KL IS NOT NULL THEN AUXR2KL 
...
CASE
        WHEN AUXR3KL IS NOT NULL THEN AUXR3KL 
WHEN AUXR3KL IS NOT NULL THEN AUXR3KL 
WHEN AUXR3KL IS NOT NULL THEN AUXR3KL 
...
CASE
        WHEN AUXR4KL IS NOT NULL THEN AUXR4KL 
WHEN AUXR4KL IS NOT NULL THEN AUXR4KL 
WHEN AUXR4KL IS NOT NULL THEN AUXR4KL 
...
CASE
        WHEN AUXR6KL IS NOT NULL THEN AUXR6KL 
WHEN AUXR6KL IS NOT NULL THEN AUXR6KL 
WHEN AUXR6KL IS NOT NULL THEN AUXR6KL 
...
CASE
        WHEN AUXR8KL IS NOT NULL THEN AUXR8KL 
WHEN AUXR8KL IS NOT NULL THEN AUXR8KL 
WHEN AUXR8KL IS NOT NULL THEN AUXR8KL 
