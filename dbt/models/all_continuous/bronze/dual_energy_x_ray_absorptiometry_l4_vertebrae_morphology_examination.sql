...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DXXANIDX AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(12 AS FLOAT64),0) AS INT64) THEN '12' -- categorize numeric values
WHEN DXXANIDX IS NULL THEN NULL 
ELSE SAFE_CAST(DXXANIDX AS STRING) 
 END as number_of_vertebra, 

CASE
    WHEN REPLACE(DXXLABEL,'.0','') = 'L4' THEN 'L4' -- categorize string values 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DXXL4_H.htm
*/
