...
ELSE SAFE_CAST(ECD010 AS FLOAT64) 
...
ELSE SAFE_CAST(ECD070A AS FLOAT64) 
 END as weight_at_birth_pounds, 

CASE
    WHEN ECD070B IS NULL THEN NULL 
ELSE SAFE_CAST(ECD070B AS FLOAT64) 
...
ELSE SAFE_CAST(ECQ010 AS FLOAT64) 
