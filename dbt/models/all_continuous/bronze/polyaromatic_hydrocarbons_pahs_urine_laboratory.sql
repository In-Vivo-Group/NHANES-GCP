...
CASE
WHEN URXP19 IS NULL THEN NULL 
ELSE SAFE_CAST(URXP19 AS FLOAT64) 
 END as lab_4_phenanthrene_ng_l, 

CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDP19LC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDP19LC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Below lower detection limit' -- categorize numeric values
WHEN URDP19LC IS NULL THEN NULL 
ELSE SAFE_CAST(URDP19LC AS STRING) 
 END as lab_4_phenanthrene_comment_code, 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_polyaromatic_hydrocarbons_pahs_urine_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/PAH_G.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2007-2008/PAH_E.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/PAH_D.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2003-2004/L31PAH_C.htm
*/
