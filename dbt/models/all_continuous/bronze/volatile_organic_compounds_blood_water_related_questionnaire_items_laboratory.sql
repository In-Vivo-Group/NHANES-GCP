...
ELSE SAFE_CAST(LBDV2ELC AS STRING) 
 END as blood_1_1_2_trichloroethane_comment_code, 
...
CASE
    WHEN LBXV4T IS NULL THEN NULL 
ELSE SAFE_CAST(LBXV4T AS FLOAT64) 
 END as blood_1_1_2_2_tetrachloroethane_ng_ml, 

CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(LBDV4TLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN 'detectable result' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBDV4TLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'below detectable limit' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBDV4TLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'detectable result and exceeds the calibrated range of assay' -- categorize numeric values
WHEN LBDV4TLC IS NULL THEN NULL 
ELSE SAFE_CAST(LBDV4TLC AS STRING) 
 END as blood_1_1_2_2_tetrachloroethane_comt, 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2003-2004/L04VOC_C.htm
*/
