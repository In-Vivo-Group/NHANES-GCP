...
ELSE SAFE_CAST(PFQ060A AS STRING) 
 END as managing_money_difficulty, 
...
ELSE SAFE_CAST(PFQ060B AS STRING) 
 END as walking_for_a_quarter_mile_difficulty, 
...
ELSE SAFE_CAST(PFQ060C AS STRING) 
 END as walking_up_ten_steps_difficulty, 
...
ELSE SAFE_CAST(PFQ060D AS STRING) 
 END as stooping_crouching_kneeling_difficulty, 
...
ELSE SAFE_CAST(PFQ060E AS STRING) 
 END as lifting_or_carrying_difficulty, 
...
ELSE SAFE_CAST(PFQ060G AS STRING) 
 END as preparing_meals_difficulty, 
...
ELSE SAFE_CAST(PFQ060H AS STRING) 
 END as walking_between_rooms_on_same_floor, 
...
ELSE SAFE_CAST(PFQ060I AS STRING) 
 END as standingup_from_armless_chair_difficulty, 
...
ELSE SAFE_CAST(PFQ060J AS STRING) 
 END as getting_in_and_out_of_bed_difficulty, 
...
ELSE SAFE_CAST(PFQ060K AS STRING) 
 END as using_fork_knife_drinking_from_cup, 
...
ELSE SAFE_CAST(PFQ060L AS STRING) 
 END as dressing_yourself_difficulty, 
...
ELSE SAFE_CAST(PFQ060M AS STRING) 
 END as standing_for_long_periods_difficulty, 
...
ELSE SAFE_CAST(PFQ060N AS STRING) 
 END as sitting_for_long_periods_difficulty, 
...
ELSE SAFE_CAST(PFQ060O AS STRING) 
 END as reaching_up_over_head_difficulty, 
...
ELSE SAFE_CAST(PFQ060P AS STRING) 
 END as grasp_holding_small_objects_difficulty, 
...
ELSE SAFE_CAST(PFQ060Q AS STRING) 
 END as going_out_to_movies_events_difficulty, 
...
ELSE SAFE_CAST(PFQ060R AS STRING) 
 END as attending_social_event_difficulty, 
...
ELSE SAFE_CAST(PFQ060S AS STRING) 
 END as leisure_activity_at_home_difficulty, 
...
ELSE SAFE_CAST(PFD067A AS STRING) 
 END as health_problems_causing_difficulty, 
...
ELSE SAFE_CAST(PFD069AQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069BQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069CQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069DQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069EQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069FQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069GQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069HQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069IQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069JQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069KQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069LQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069MQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069NQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFQ069OQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069PQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069QQ AS FLOAT64) 
...
ELSE SAFE_CAST(PFD069RQ AS FLOAT64) 
