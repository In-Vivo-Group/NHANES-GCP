...
ELSE SAFE_CAST(WTSB2YR AS FLOAT64) 
 END as environmental_b_two_year_weights, 
...
CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDMCPLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDMCPLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Below lower detection limit' -- categorize numeric values
WHEN URDMCPLC IS NULL THEN NULL 
ELSE SAFE_CAST(URDMCPLC AS STRING) 
 END as mono_cyclohexyl_phthalate_comment_code, 
...
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDMHPLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(37 AS FLOAT64),0) AS INT64) THEN '37' -- categorize numeric values
...
CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDMOPLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(URDMOPLC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Below lower detection limit' -- categorize numeric values
WHEN URDMOPLC IS NULL THEN NULL 
ELSE SAFE_CAST(URDMOPLC AS STRING) 
 END as mono_n_octyl_phthalate_comment_code, 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_phthalates_urine_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2009-2010/PHTHTE_F.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2007-2008/PHTHTE_E.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/PHTHTE_D.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2003-2004/L24PH_C.htm
*/
