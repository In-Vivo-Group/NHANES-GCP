...
CASE
            WHEN CBQ506 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ506 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ506 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ506 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ506 IS NULL THEN NULL 
ELSE CBQ506 
 END as buy_food_from_fast_food_pizza_places, 

CASE
            WHEN CBQ536 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ536 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ536 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ536 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ536 IS NULL THEN NULL 
ELSE CBQ536 
 END as notice_calories_at_fast_food_pizza_place, 

CASE
            WHEN CBQ541 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ541 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ541 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ541 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ541 IS NULL THEN NULL 
ELSE CBQ541 
 END as use_calorie_info_at_fast_food_pizza, 

CASE
            WHEN CBQ551 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ551 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ551 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ551 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ551 IS NULL THEN NULL 
ELSE CBQ551 
 END as eat_from_restaurant_w_waiter, 

CASE
            WHEN CBQ581 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ581 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ581 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ581 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ581 IS NULL THEN NULL 
ELSE CBQ581 
 END as notice_calories_at_restaurant_w_waiter, 

CASE
            WHEN CBQ586 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ586 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ586 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ586 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ586 IS NULL THEN NULL 
ELSE CBQ586 
 END as use_calorie_info_at_restaurant_w_waiter, 

CASE
            WHEN CBQ830 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ830 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ830 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ830 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ830 IS NULL THEN NULL 
ELSE CBQ830 
 END as eat_at_all_you_can_eat_buffet, 

CASE
            WHEN CBQ835 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ835 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ835 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ835 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ835 IS NULL THEN NULL 
ELSE CBQ835 
 END as notice_calorie_info_at_buffet, 

CASE
            WHEN CBQ840 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ840 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ840 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ840 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ840 IS NULL THEN NULL 
ELSE CBQ840 
 END as use_calorie_information_at_buffet, 

CASE
            WHEN CBQ845 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ845 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ845 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ845 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ845 IS NULL THEN NULL 
ELSE CBQ845 
 END as buy_from_coffee_shop_juice_bar, 

CASE
            WHEN CBQ850 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ850 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ850 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ850 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ850 IS NULL THEN NULL 
ELSE CBQ850 
 END as notice_calorie_info_at_coffee_shop, 

CASE
            WHEN CBQ855 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ855 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ855 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ855 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ855 IS NULL THEN NULL 
ELSE CBQ855 
 END as use_calorie_info_at_coffee_shop, 

CASE
            WHEN CBQ860 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ860 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ860 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ860 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ860 IS NULL THEN NULL 
ELSE CBQ860 
 END as buy_at_recreational_places, 

CASE
            WHEN CBQ865 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ865 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ865 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ865 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ865 IS NULL THEN NULL 
ELSE CBQ865 
 END as notice_calories_at_recreational_places, 

CASE
            WHEN CBQ870 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ870 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ870 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ870 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ870 IS NULL THEN NULL 
ELSE CBQ870 
 END as use_calorie_info_at_recreational_places, 

CASE
            WHEN CBQ875 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ875 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ875 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ875 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ875 IS NULL THEN NULL 
ELSE CBQ875 
 END as buy_prepared_foods_from_grocery_store, 

CASE
            WHEN CBQ880 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ880 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ880 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ880 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ880 IS NULL THEN NULL 
ELSE CBQ880 
 END as notice_calorie_info_at_grocery_store, 

CASE
            WHEN CBQ885 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ885 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ885 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ885 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ885 IS NULL THEN NULL 
ELSE CBQ885 
 END as use_calorie_info_at_grocery_store, 

CASE
            WHEN CBQ890 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ890 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ890 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ890 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ890 IS NULL THEN NULL 
ELSE CBQ890 
 END as buy_prepared_food_at_convenience_store, 

CASE
            WHEN CBQ895 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ895 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ895 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ895 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ895 IS NULL THEN NULL 
ELSE CBQ895 
 END as notice_calorie_info_at_convenience_store, 

CASE
            WHEN CBQ900 = 1 THEN 'Yes' -- categorize numeric values
WHEN CBQ900 = 2 THEN 'No' -- categorize numeric values
WHEN CBQ900 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ900 = 9 THEN 'Dont know' -- categorize numeric values
...
CASE
            WHEN CBQ905 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ905 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ905 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ905 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ905 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ905 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ905 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ905 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ905 IS NULL THEN NULL 
ELSE CBQ905 
 END as use_number_of_servings_on_food_label, 

CASE
            WHEN CBQ910 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ910 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ910 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ910 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ910 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ910 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ910 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ910 = 9 THEN 'Dont know' -- categorize numeric values
...
CASE
            WHEN CBQ915 = 1 THEN 'Only percent daily value' -- categorize numeric values
WHEN CBQ915 = 2 THEN 'Percent daily value more often' -- categorize numeric values
WHEN CBQ915 = 3 THEN 'Both percent daily value and amount of nutrients about the same' -- categorize numeric values
WHEN CBQ915 = 4 THEN 'Amount of nutrients more often' -- categorize numeric values
WHEN CBQ915 = 5 THEN 'Only amount of nutrients' -- categorize numeric values
WHEN CBQ915 = 6 THEN 'Do not use either' -- categorize numeric values
WHEN CBQ915 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ915 = 9 THEN 'Dont know' -- categorize numeric values
...
WHEN CBQ925 = 2 THEN 'One serving contains 5% Vit A by weight' -- categorize numeric values
WHEN CBQ925 = 3 THEN 'One serving supplies 5% of the Vit A you should have in a day' -- categorize numeric values
WHEN CBQ925 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ925 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ925 IS NULL THEN NULL 
ELSE CBQ925 
 END as what_does_5_daily_value_mean, 

CASE
            WHEN CBQ930 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ930 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ930 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ930 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ930 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ930 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ930 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ930 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ930 IS NULL THEN NULL 
ELSE CBQ930 
 END as use_calorie_information_on_food_label, 

CASE
            WHEN CBQ935 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ935 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ935 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ935 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ935 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ935 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ935 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ935 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ935 IS NULL THEN NULL 
ELSE CBQ935 
 END as use_sugars_info_on_food_label, 

CASE
            WHEN CBQ945 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ945 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ945 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ945 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ945 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ945 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ945 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ945 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBQ945 IS NULL THEN NULL 
ELSE CBQ945 
 END as use_sodium_info_on_food_label, 

CASE
            WHEN CBQ950 = 1 THEN 'Always' -- categorize numeric values
WHEN CBQ950 = 2 THEN 'Most of the time' -- categorize numeric values
WHEN CBQ950 = 3 THEN 'Sometimes' -- categorize numeric values
WHEN CBQ950 = 4 THEN 'Rarely' -- categorize numeric values
WHEN CBQ950 = 5 THEN 'Never' -- categorize numeric values
WHEN CBQ950 = 6 THEN 'Never seen' -- categorize numeric values
WHEN CBQ950 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBQ950 = 9 THEN 'Dont know' -- categorize numeric values
...
CASE
            WHEN DBD930 = 1 THEN 'Yes' -- categorize numeric values
WHEN DBD930 = 2 THEN 'No' -- categorize numeric values
WHEN DBD930 = 7 THEN 'Refused' -- categorize numeric values
WHEN DBD930 = 9 THEN 'Dont know' -- categorize numeric values
WHEN DBD930 IS NULL THEN NULL 
ELSE DBD930 
 END as respondent_is_main_meal_planner_preparer, 

CASE
            WHEN DBD935 = 1 THEN 'Yes' -- categorize numeric values
WHEN DBD935 = 2 THEN 'No' -- categorize numeric values
WHEN DBD935 = 7 THEN 'Refused' -- categorize numeric values
WHEN DBD935 = 9 THEN 'Dont know' -- categorize numeric values
WHEN DBD935 IS NULL THEN NULL 
ELSE DBD935 
 END as respondent_shares_meal_preparation_duty, 

CASE
            WHEN DBD940 = 1 THEN 'Yes' -- categorize numeric values
WHEN DBD940 = 2 THEN 'No' -- categorize numeric values
WHEN DBD940 = 7 THEN 'Refused' -- categorize numeric values
WHEN DBD940 = 9 THEN 'Dont know' -- categorize numeric values
WHEN DBD940 IS NULL THEN NULL 
ELSE DBD940 
 END as respondent_is_main_food_shopper, 

CASE
            WHEN DBD945 = 1 THEN 'Yes' -- categorize numeric values
WHEN DBD945 = 2 THEN 'No' -- categorize numeric values
WHEN DBD945 = 7 THEN 'Refused' -- categorize numeric values
WHEN DBD945 = 9 THEN 'Dont know' -- categorize numeric values
...
CASE
            WHEN CBD765 = 1 THEN 'Less than high school' -- categorize numeric values
WHEN CBD765 = 2 THEN 'High school diploma (including GED)' -- categorize numeric values
WHEN CBD765 = 3 THEN 'More than high school' -- categorize numeric values
WHEN CBD765 = 7 THEN 'Refused' -- categorize numeric values
WHEN CBD765 = 9 THEN 'Dont know' -- categorize numeric values
WHEN CBD765 IS NULL THEN NULL 
ELSE CBD765 
 END as respondent_s_education_level, 

CASE
            WHEN CBD770 = 1 THEN 'Male' -- categorize numeric values
WHEN CBD770 = 2 THEN 'Female' -- categorize numeric values
...
WHEN CBQ785 = 4 THEN 'Other' -- categorize numeric values
