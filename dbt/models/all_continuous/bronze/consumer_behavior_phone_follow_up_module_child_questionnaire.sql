...
WHEN SAFE_CAST(ROUND(SAFE_CAST(CBD765 AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'High school diploma (including GED), or' -- categorize numeric values
