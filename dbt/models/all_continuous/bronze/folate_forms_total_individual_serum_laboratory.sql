...
CASE
            WHEN SAFE_CAST(LBDSF1LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF1LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
ELSE SAFE_CAST(LBXSF2SI AS STRING) 
 END as folic_acid_nmol_l, 

CASE
            WHEN SAFE_CAST(LBDSF2LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF2LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
ELSE SAFE_CAST(LBXSF3SI AS STRING) 
 END as lab_5_formyl_tetrahydrofolate_nmol_l, 

CASE
            WHEN SAFE_CAST(LBDSF3LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF3LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
ELSE SAFE_CAST(LBXSF4SI AS STRING) 
 END as tetrahydrofolate_nmol_l, 

CASE
            WHEN SAFE_CAST(LBDSF4LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF4LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
ELSE SAFE_CAST(LBXSF5SI AS STRING) 
 END as lab_5_10_methenyl_tetrahydrofolate_nmol_l, 

CASE
            WHEN SAFE_CAST(LBDSF5LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF5LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
ELSE SAFE_CAST(LBXSF6SI AS STRING) 
 END as mefox_oxidation_product_nmol_l, 

CASE
            WHEN SAFE_CAST(LBDSF6LC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(LBDSF6LC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
