...
ELSE SAFE_CAST(URDUDALC AS STRING) 
 END as urinary_dimethylarsonic_acid_coment_code, 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_speciated_arsenics_urine_special_sample_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/UASS_I.htm
*/
