...
WHEN REPLACE(DSDSUPP,'.0','') = '' THEN '' -- categorize string values 
...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DSQ128G AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(16 AS FLOAT64),0) AS INT64) THEN 'TO SUPPLEMENT MY DIET (BECAUSE I DONT GET ENOUGH FROM FOOD)' -- categorize numeric values
...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DSQ128M AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(22 AS FLOAT64),0) AS INT64) THEN 'FOR SKIN HEALTH, DRY SKIN' -- categorize numeric values
WHEN DSQ128M IS NULL THEN NULL 
ELSE SAFE_CAST(DSQ128M AS STRING) 
 END as for_skin_health_dry_skin, 
...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DSD128BB AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(36 AS FLOAT64),0) AS INT64) THEN 'FOR MUSCLE RELATED ISSUES' -- categorize numeric values
WHEN DSD128BB IS NULL THEN NULL 
ELSE SAFE_CAST(DSD128BB AS STRING) 
 END as for_muscle_related_issues, 
...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DSD128FF AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(40 AS FLOAT64),0) AS INT64) THEN 'FOR LIVER HEALTH, DETOXIFICATION' -- categorize numeric values
