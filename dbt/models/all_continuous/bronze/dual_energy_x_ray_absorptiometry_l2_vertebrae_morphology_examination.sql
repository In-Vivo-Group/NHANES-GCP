...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DXXANIDX AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(10 AS FLOAT64),0) AS INT64) THEN '10' -- categorize numeric values
WHEN DXXANIDX IS NULL THEN NULL 
ELSE SAFE_CAST(DXXANIDX AS STRING) 
 END as number_of_vertebra, 

CASE
    WHEN REPLACE(DXXLABEL,'.0','') = 'L2' THEN 'L2' -- categorize string values 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DXXL2_H.htm
*/
