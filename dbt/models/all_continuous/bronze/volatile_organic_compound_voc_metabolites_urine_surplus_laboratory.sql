...
ELSE SAFE_CAST(URX1DC AS FLOAT64) 
...
ELSE SAFE_CAST(URX2DC AS FLOAT64) 
...
ELSE SAFE_CAST(URXMB3 AS FLOAT64) 
 END as n_a_s_4_hydrxy_2butn_l_yl_l_cys_ng_ml, 
...
ELSE SAFE_CAST(URDMB3LC AS STRING) 
 END as n_a_s_4_hydrxy_2butn_l_yl_l_cys_comt, 

CASE
    WHEN URXMB2 IS NULL THEN NULL 
ELSE SAFE_CAST(URXMB2 AS FLOAT64) 
 END as n_ac_s_2_hydrxy_3_butnyl_l_cys_ng_ml, 
...
ELSE SAFE_CAST(URDMB2LC AS STRING) 
 END as n_ac_s_2_hydrxy_3_butnyl_l_cys_comt, 
...
ELSE SAFE_CAST(URXTCV AS FLOAT64) 
...
ELSE SAFE_CAST(URXTTC AS FLOAT64) 
 END as lab_2_thoxothazlidne_4_carbxylic_acid_ng_ml, 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_volatile_organic_compound_voc_metabolites_urine_surplus_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2005-2006/SSUVOC_D.htm
*/
