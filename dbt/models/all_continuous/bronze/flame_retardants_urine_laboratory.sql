...
CASE
            WHEN SAFE_CAST(URDBCPLC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDBCPLC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
CASE
            WHEN SAFE_CAST(URDCEPLC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDCEPLC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
CASE
            WHEN SAFE_CAST(URDBDCLC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDBDCLC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
CASE
            WHEN SAFE_CAST(URDDUPLC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDDUPLC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
CASE
            WHEN SAFE_CAST(URDDPHLC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDDPHLC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
...
CASE
            WHEN SAFE_CAST(URDBBALC AS FLOAT64) = SAFE_CAST(0 AS FLOAT64) THEN 'At or above the detection limit' -- categorize numeric values
WHEN SAFE_CAST(URDBBALC AS FLOAT64) = SAFE_CAST(1 AS FLOAT64) THEN 'Below lower detection limit' -- categorize numeric values
