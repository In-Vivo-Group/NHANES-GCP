...
ELSE SAFE_CAST(URX2MH AS STRING) 
...
ELSE SAFE_CAST(URX34M AS STRING) 
...
ELSE SAFE_CAST(URXAAM AS STRING) 
...
ELSE SAFE_CAST(URXAMC AS STRING) 
...
ELSE SAFE_CAST(URXATC AS STRING) 
...
ELSE SAFE_CAST(URXBMA AS STRING) 
...
ELSE SAFE_CAST(URXBPM AS STRING) 
...
ELSE SAFE_CAST(URXCEM AS STRING) 
...
ELSE SAFE_CAST(URXCYHA AS STRING) 
...
ELSE SAFE_CAST(URXCYM AS STRING) 
...
ELSE SAFE_CAST(URXDHB AS STRING) 
...
ELSE SAFE_CAST(URXGAM AS STRING) 
...
ELSE SAFE_CAST(URXHEM AS STRING) 
...
ELSE SAFE_CAST(URXHP2 AS STRING) 
...
ELSE SAFE_CAST(URXHPM AS STRING) 
...
ELSE SAFE_CAST(URXIPM3 AS STRING) 
...
ELSE SAFE_CAST(URXMAD AS STRING) 
...
ELSE SAFE_CAST(URXMB3 AS STRING) 
...
ELSE SAFE_CAST(URXPHE AS STRING) 
...
ELSE SAFE_CAST(URXPHG AS STRING) 
...
ELSE SAFE_CAST(URXPMM AS STRING) 
...
ELSE SAFE_CAST(URXTTC AS STRING) 
...
ELSE SAFE_CAST(URXDPM AS STRING) 
...
ELSE SAFE_CAST(URXIPM1 AS STRING) 
...
ELSE SAFE_CAST(URXMB1 AS STRING) 
...
ELSE SAFE_CAST(URXMB2 AS STRING) 
...
ELSE SAFE_CAST(URXPMA AS STRING) 
