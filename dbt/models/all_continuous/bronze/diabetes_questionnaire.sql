...
CASE
            WHEN SAFE_CAST(DID040 AS FLOAT64) > 79.0 THEN NULL -- remove missing, dont know, categories in float field  
...
CASE
            WHEN SAFE_CAST(DID060 AS FLOAT64) > 59.0 THEN NULL -- remove missing, dont know, categories in float field  
...
CASE
            WHEN SAFE_CAST(DID250 AS FLOAT64) > 40.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID250 IS NULL THEN NULL 
ELSE DID250 
 END as past_year_how_many_times_seen_doctor, 

CASE
            WHEN SAFE_CAST(DID260 AS FLOAT64) > 50.0 THEN NULL -- remove missing, dont know, categories in float field  
...
CASE
            WHEN SAFE_CAST(DIQ280 AS FLOAT64) > 16.0 THEN NULL -- remove missing, dont know, categories in float field  
...
CASE
            WHEN SAFE_CAST(DIQ300D AS FLOAT64) > 190.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DIQ300D IS NULL THEN NULL 
ELSE DIQ300D 
 END as what_was_your_recent_dbp, 

CASE
            WHEN SAFE_CAST(DID310S AS FLOAT64) > 180.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID310S IS NULL THEN NULL 
ELSE DID310S 
 END as what_does_dr_say_sbp_should_be, 

CASE
            WHEN SAFE_CAST(DID310D AS FLOAT64) > 140.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID310D IS NULL THEN NULL 
ELSE DID310D 
 END as what_does_dr_say_dbp_should_be, 

CASE
            WHEN SAFE_CAST(DID320 AS FLOAT64) > 340.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID320 IS NULL THEN NULL 
ELSE DID320 
 END as what_was_most_recent_ldl_number, 

CASE
            WHEN SAFE_CAST(DID330 AS FLOAT64) > 250.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID330 IS NULL THEN NULL 
ELSE DID330 
 END as what_does_dr_say_ldl_should_be, 

CASE
            WHEN SAFE_CAST(DID341 AS FLOAT64) > 106.0 THEN NULL -- remove missing, dont know, categories in float field  
WHEN DID341 IS NULL THEN NULL 
ELSE DID341 
 END as past_year_times_dr_check_feet_for_sores, 

CASE
            WHEN SAFE_CAST(DID350 AS FLOAT64) > 30.0 THEN NULL -- remove missing, dont know, categories in float field  
