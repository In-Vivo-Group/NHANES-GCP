...
ELSE SAFE_CAST(VTQ241B AS FLOAT64) 
 END as how_long_ago_did_you_cook_w_natural_gas, 
...
ELSE SAFE_CAST(VTQ244A AS STRING) 
 END as did_you_pump_gas_in_to_your_car, 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_volatile_organic_compounds_vocs_and_trihalomethanes_mtbe_blood_special_sample_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/VOCWBS_H.htm
*/
