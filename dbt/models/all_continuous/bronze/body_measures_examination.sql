...
ELSE SAFE_CAST(BMXWT AS FLOAT64) 
 END as weight_kg, 
...
ELSE SAFE_CAST(BMXRECUM AS FLOAT64) 
...
ELSE SAFE_CAST(BMXHEAD AS FLOAT64) 
...
ELSE SAFE_CAST(BMXHT AS FLOAT64) 
...
ELSE SAFE_CAST(BMXBMI AS FLOAT64) 
 END as body_mass_index_kg_m_2, 

CASE
WHEN BMXLEG IS NULL THEN NULL 
ELSE SAFE_CAST(BMXLEG AS FLOAT64) 
...
ELSE SAFE_CAST(BMXARML AS FLOAT64) 
...
ELSE SAFE_CAST(BMXARMC AS FLOAT64) 
...
ELSE SAFE_CAST(BMXWAIST AS FLOAT64) 
...
ELSE SAFE_CAST(BMXTRI AS FLOAT64) 
...
ELSE SAFE_CAST(BMXSUB AS FLOAT64) 
...
ELSE SAFE_CAST(BMXCALF AS FLOAT64) 
...
ELSE SAFE_CAST(BMXTHICR AS FLOAT64) 
...
ELSE SAFE_CAST(BMAEXLEN AS FLOAT64) 
