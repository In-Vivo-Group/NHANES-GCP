...
ELSE SAFE_CAST(SSCLPF AS FLOAT64) 
...
ELSE SAFE_CAST(SSDONA AS FLOAT64) 
...
ELSE SAFE_CAST(SSGENX AS FLOAT64) 
...
ELSE SAFE_CAST(SSPFBA AS FLOAT64) 
...
ELSE SAFE_CAST(SSFPEA AS FLOAT64) 
...
ELSE SAFE_CAST(SSPFHA AS FLOAT64) 
...
ELSE SAFE_CAST(SSNFOA AS FLOAT64) 
...
ELSE SAFE_CAST(SSBFOA AS FLOAT64) 
...
ELSE SAFE_CAST(SSFHPS AS FLOAT64) 
...
ELSE SAFE_CAST(SSNFOS AS FLOAT64) 
...
ELSE SAFE_CAST(SSMFOS AS FLOAT64) 
