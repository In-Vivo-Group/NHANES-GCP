...
WHEN SAFE_CAST(ROUND(SAFE_CAST(LBXHCG AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Gen 1 other than a/b/not determined' -- categorize numeric values
...
https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/HEPC_J.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_HEPC.htm
*/
