...
ELSE SAFE_CAST(LBXBPB AS STRING) 
 END as blood_lead_ug_dl, 

CASE
WHEN LBDBPBSI IS NULL THEN NULL 
ELSE SAFE_CAST(LBDBPBSI AS STRING) 
...
ELSE SAFE_CAST(LBXBCD AS STRING) 
 END as blood_cadmium_ug_l, 

CASE
WHEN LBDBCDSI IS NULL THEN NULL 
ELSE SAFE_CAST(LBDBCDSI AS STRING) 
...
ELSE SAFE_CAST(LBXTHG AS STRING) 
 END as blood_mercury_total_ug_l, 

CASE
WHEN LBDTHGSI IS NULL THEN NULL 
ELSE SAFE_CAST(LBDTHGSI AS STRING) 
...
ELSE SAFE_CAST(LBXBSE AS STRING) 
 END as blood_selenium_ug_l, 

CASE
WHEN LBDBSESI IS NULL THEN NULL 
ELSE SAFE_CAST(LBDBSESI AS STRING) 
...
ELSE SAFE_CAST(LBXBMN AS STRING) 
 END as blood_manganese_ug_l, 

CASE
WHEN LBDBMNSI IS NULL THEN NULL 
ELSE SAFE_CAST(LBDBMNSI AS STRING) 
...
ELSE SAFE_CAST(WTSH2YR AS STRING) 
