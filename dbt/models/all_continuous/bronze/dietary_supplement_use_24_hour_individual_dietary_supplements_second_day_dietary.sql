...
CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2LOC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'HouseHold Interview' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2LOC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'MEC Interview' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2LOC AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Phone Interview' -- categorize numeric values
...
CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Exact or near exact match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'Probable match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(3 AS FLOAT64),0) AS INT64) THEN 'Generic match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(4 AS FLOAT64),0) AS INT64) THEN 'Reasonable match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(5 AS FLOAT64),0) AS INT64) THEN 'Default match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(6 AS FLOAT64),0) AS INT64) THEN 'No match' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(7 AS FLOAT64),0) AS INT64) THEN 'Refused' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2MTCH AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(9 AS FLOAT64),0) AS INT64) THEN 'Dont know' -- categorize numeric values
WHEN DS2MTCH IS NULL THEN NULL 
ELSE SAFE_CAST(DS2MTCH AS STRING) 
 END as matching_code, 

CASE
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2ANTA AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN 'Non-antacid supplement' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2ANTA AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(1 AS FLOAT64),0) AS INT64) THEN 'Antacid containing calcium and/or magnesium' -- categorize numeric values
WHEN SAFE_CAST(ROUND(SAFE_CAST(DS2ANTA AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(2 AS FLOAT64),0) AS INT64) THEN 'Antacids reported with antacids' -- categorize numeric values
...
https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/DS2IDS_J.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_DS2IDS.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DS2IDS_I.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DS2IDS_H.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/DS2IDS_G.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2009-2010/DS2IDS_F.htm
https://wwwn.cdc.gov/Nchs/Nhanes/2007-2008/DS2IDS_E.htm
*/
