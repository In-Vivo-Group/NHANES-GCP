...
ELSE SAFE_CAST(URXUCD AS STRING) 
...
ELSE SAFE_CAST(URXUCO AS STRING) 
...
ELSE SAFE_CAST(URXUCS AS STRING) 
...
ELSE SAFE_CAST(URXUMO AS STRING) 
...
ELSE SAFE_CAST(URXUPB AS STRING) 
...
ELSE SAFE_CAST(URXUSB AS STRING) 
...
ELSE SAFE_CAST(URXUTL AS STRING) 
...
ELSE SAFE_CAST(URXUTU AS STRING) 
...
ELSE SAFE_CAST(URXUUR AS STRING) 
...
ELSE SAFE_CAST(URXUPT AS STRING) 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/UM_I.htm
