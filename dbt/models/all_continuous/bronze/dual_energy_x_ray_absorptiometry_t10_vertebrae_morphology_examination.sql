...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DXXANIDX AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(6 AS FLOAT64),0) AS INT64) THEN '6' -- categorize numeric values
WHEN DXXANIDX IS NULL THEN NULL 
ELSE SAFE_CAST(DXXANIDX AS STRING) 
 END as number_of_vertebra, 

CASE
    WHEN REPLACE(DXXLABEL,'.0','') = 'T10' THEN 'T10' -- categorize string values 
...
CASE
    WHEN SAFE_CAST(ROUND(SAFE_CAST(DXXSPY AS FLOAT64),0) AS INT64) = SAFE_CAST(ROUND(SAFE_CAST(0 AS FLOAT64),0) AS INT64) THEN '0' -- categorize numeric values
WHEN DXXSPY IS NULL THEN NULL 
ELSE SAFE_CAST(DXXSPY AS STRING) 
...
https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DXXT10_H.htm
*/
