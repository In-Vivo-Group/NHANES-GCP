...
CASE
    WHEN LBCGHC IS NULL THEN NULL 
ELSE SAFE_CAST(LBCGHC AS FLOAT64) 
 END as gamma_hexachlorocyclohexane_pg_g, 

CASE
    WHEN LBCGHCLA IS NULL THEN NULL 
ELSE SAFE_CAST(LBCGHCLA AS FLOAT64) 
...
doc_file_url,
dataset,
 FROM {{ ref('stg_pesticides_organochlorine_pesticides_pooled_samples_laboratory') }}

/* 
Docs utilized to generate this SQL can be found at:
https://wwwn.cdc.gov/Nchs/Nhanes/2009-2010/PSTPOL_F.htm
*/
