...
CASE
        WHEN RIDAGEYR IS NOT NULL THEN RIDAGEYR 
WHEN RIDAGEYR IS NOT NULL THEN RIDAGEYR 
...
CASE
        WHEN RIDAGEMN IS NOT NULL THEN RIDAGEMN 
...
CASE
        WHEN RIDEXAGM IS NOT NULL THEN RIDEXAGM 
...
WHEN DMQMILIZ = 9 THEN 'Dont Know' 
...
WHEN DMDBORN4 = 99 THEN 'Dont Know' 
...
WHEN DMDCITZN = 9 THEN 'Dont Know' 
...
WHEN DMDYRSUS = 99 THEN 'Dont Know' 
...
WHEN DMDEDUC3 = 99 THEN 'Dont Know' 
...
WHEN DMDEDUC2 = 9 THEN 'Dont Know' 
...
WHEN DMDMARTL = 99 THEN 'Dont Know' 
...
WHEN DMDHREDZ = '9' THEN 'Dont Know' 
...
WHEN DMDHRMAZ = '99' THEN 'Dont Know' 
...
CASE
        WHEN SDMVPSU IS NOT NULL THEN SDMVPSU 
WHEN SDMVPSU IS NULL THEN NULL 
ELSE NULL 
 END as masked_variance_pseudo_psu, 

CASE
        WHEN SDMVSTRA IS NOT NULL THEN SDMVSTRA 
...
WHEN INDHHIN2 = 99 THEN 'Dont know' 
...
WHEN INDFMIN2 = 99 THEN 'Dont know' 
WHEN INDFMIN2 IS NULL THEN NULL 
ELSE NULL 
 END as annual_family_income, 

CASE
        WHEN INDFMPIR IS NOT NULL THEN INDFMPIR 
WHEN INDFMPIR IS NOT NULL THEN INDFMPIR 
