...
WHEN DIQ010 = 9 THEN 'Dont know' 
WHEN DIQ010 IS NULL THEN NULL 
ELSE NULL 
 END as doctor_told_you_have_diabetes, 

CASE
        WHEN DID040 IS NOT NULL THEN SAFE_CAST(DID040 AS FLOAT64) 
WHEN DID040 IS NOT NULL THEN SAFE_CAST(DID040 AS FLOAT64) 
WHEN DID040 IS NOT NULL THEN SAFE_CAST(DID040 AS FLOAT64) 
WHEN DID040 IS NOT NULL THEN SAFE_CAST(DID040 AS FLOAT64) 
WHEN DID040 IS NOT NULL THEN SAFE_CAST(DID040 AS FLOAT64) 
...
WHEN DIQ175A = '99' THEN 'Dont know' 
...
WHEN DIQ050 = 9 THEN 'Dont know' 
WHEN DIQ050 IS NULL THEN NULL 
ELSE NULL 
 END as taking_insulin_now, 

CASE
        WHEN DID060 IS NOT NULL THEN SAFE_CAST(DID060 AS FLOAT64) 
WHEN DID060 IS NOT NULL THEN SAFE_CAST(DID060 AS FLOAT64) 
WHEN DID060 IS NOT NULL THEN SAFE_CAST(DID060 AS FLOAT64) 
WHEN DID060 IS NOT NULL THEN SAFE_CAST(DID060 AS FLOAT64) 
...
WHEN DIQ240 = '9' THEN 'Dont know' 
WHEN DIQ240 IS NULL THEN NULL 
ELSE NULL 
 END as is_there_one_dr_you_see_for_diabetes, 

CASE
        WHEN DID250 IS NOT NULL THEN SAFE_CAST(DID250 AS FLOAT64) 
WHEN DID250 IS NOT NULL THEN SAFE_CAST(DID250 AS FLOAT64) 
WHEN DID250 IS NOT NULL THEN SAFE_CAST(DID250 AS FLOAT64) 
WHEN DID250 IS NOT NULL THEN SAFE_CAST(DID250 AS FLOAT64) 
...
CASE
        WHEN DID260 IS NOT NULL THEN SAFE_CAST(DID260 AS FLOAT64) 
WHEN DID260 IS NOT NULL THEN SAFE_CAST(DID260 AS FLOAT64) 
WHEN DID260 IS NOT NULL THEN SAFE_CAST(DID260 AS FLOAT64) 
WHEN DID260 IS NOT NULL THEN SAFE_CAST(DID260 AS FLOAT64) 
...
WHEN DIQ275 = '9' THEN 'Dont know' 
WHEN DIQ275 IS NULL THEN NULL 
ELSE NULL 
 END as past_year_dr_checked_for_a1c, 

CASE
        WHEN DIQ280 IS NOT NULL THEN SAFE_CAST(DIQ280 AS FLOAT64) 
WHEN DIQ280 IS NOT NULL THEN SAFE_CAST(DIQ280 AS FLOAT64) 
WHEN DIQ280 IS NOT NULL THEN SAFE_CAST(DIQ280 AS FLOAT64) 
...
CASE
        WHEN DIQ300S IS NOT NULL THEN SAFE_CAST(DIQ300S AS FLOAT64) 
WHEN DIQ300S IS NOT NULL THEN SAFE_CAST(DIQ300S AS FLOAT64) 
WHEN DIQ300S IS NOT NULL THEN SAFE_CAST(DIQ300S AS FLOAT64) 
...
CASE
        WHEN DIQ300D IS NOT NULL THEN SAFE_CAST(DIQ300D AS FLOAT64) 
WHEN DIQ300D IS NOT NULL THEN SAFE_CAST(DIQ300D AS FLOAT64) 
WHEN DIQ300D IS NOT NULL THEN SAFE_CAST(DIQ300D AS FLOAT64) 
...
CASE
        WHEN DID310S IS NOT NULL THEN SAFE_CAST(DID310S AS FLOAT64) 
WHEN DID310S IS NOT NULL THEN SAFE_CAST(DID310S AS FLOAT64) 
WHEN DID310S IS NOT NULL THEN SAFE_CAST(DID310S AS FLOAT64) 
WHEN DID310S IS NOT NULL THEN SAFE_CAST(DID310S AS FLOAT64) 
...
CASE
        WHEN DID310D IS NOT NULL THEN SAFE_CAST(DID310D AS FLOAT64) 
WHEN DID310D IS NOT NULL THEN SAFE_CAST(DID310D AS FLOAT64) 
WHEN DID310D IS NOT NULL THEN SAFE_CAST(DID310D AS FLOAT64) 
WHEN DID310D IS NOT NULL THEN SAFE_CAST(DID310D AS FLOAT64) 
...
CASE
        WHEN DID320 IS NOT NULL THEN SAFE_CAST(DID320 AS FLOAT64) 
WHEN DID320 IS NOT NULL THEN SAFE_CAST(DID320 AS FLOAT64) 
WHEN DID320 IS NOT NULL THEN SAFE_CAST(DID320 AS FLOAT64) 
WHEN DID320 IS NOT NULL THEN SAFE_CAST(DID320 AS FLOAT64) 
WHEN DID320 IS NOT NULL THEN SAFE_CAST(DID320 AS FLOAT64) 
...
CASE
        WHEN DID330 IS NOT NULL THEN SAFE_CAST(DID330 AS FLOAT64) 
WHEN DID330 IS NOT NULL THEN SAFE_CAST(DID330 AS FLOAT64) 
WHEN DID330 IS NOT NULL THEN SAFE_CAST(DID330 AS FLOAT64) 
WHEN DID330 IS NOT NULL THEN SAFE_CAST(DID330 AS FLOAT64) 
...
CASE
        WHEN DID341 IS NOT NULL THEN SAFE_CAST(DID341 AS FLOAT64) 
WHEN DID341 IS NOT NULL THEN SAFE_CAST(DID341 AS FLOAT64) 
WHEN DID341 IS NOT NULL THEN SAFE_CAST(DID341 AS FLOAT64) 
WHEN DID341 IS NOT NULL THEN SAFE_CAST(DID341 AS FLOAT64) 
...
CASE
        WHEN DID350 IS NOT NULL THEN SAFE_CAST(DID350 AS FLOAT64) 
WHEN DID350 IS NOT NULL THEN SAFE_CAST(DID350 AS FLOAT64) 
WHEN DID350 IS NOT NULL THEN SAFE_CAST(DID350 AS FLOAT64) 
WHEN DID350 IS NOT NULL THEN SAFE_CAST(DID350 AS FLOAT64) 
