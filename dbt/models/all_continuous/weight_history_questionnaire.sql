...
CASE
        WHEN WHD010 IS NOT NULL THEN WHD010 
WHEN WHD010 IS NOT NULL THEN WHD010 
WHEN WHD010 IS NOT NULL THEN WHD010 
...
CASE
        WHEN WHD020 IS NOT NULL THEN WHD020 
WHEN WHD020 IS NOT NULL THEN WHD020 
WHEN WHD020 IS NOT NULL THEN WHD020 
...
CASE
        WHEN WHD120 IS NOT NULL THEN WHD120 
WHEN WHD120 IS NOT NULL THEN WHD120 
WHEN WHD120 IS NOT NULL THEN WHD120 
...
CASE
        WHEN WHD130 IS NOT NULL THEN WHD130 
WHEN WHD130 IS NOT NULL THEN WHD130 
WHEN WHD130 IS NOT NULL THEN WHD130 
...
CASE
        WHEN WHD140 IS NOT NULL THEN WHD140 
WHEN WHD140 IS NOT NULL THEN WHD140 
WHEN WHD140 IS NOT NULL THEN WHD140 
...
CASE
        WHEN WHQ150 IS NOT NULL THEN WHQ150 
WHEN WHQ150 IS NOT NULL THEN WHQ150 
WHEN WHQ150 IS NOT NULL THEN WHQ150 
WHEN WHQ150 IS NOT NULL THEN WHQ150 
...
WHEN WHQ190 = '9' THEN 'Dont know' 
WHEN WHQ190 IS NULL THEN NULL 
ELSE NULL 
 END as have_you_ever_had_wt_loss_surgery, 

CASE
        WHEN WHQ200 IS NOT NULL THEN SAFE_CAST(WHQ200 AS FLOAT64) 
WHEN WHQ200 IS NOT NULL THEN SAFE_CAST(WHQ200 AS FLOAT64) 
WHEN WHQ200 IS NOT NULL THEN SAFE_CAST(WHQ200 AS FLOAT64) 
