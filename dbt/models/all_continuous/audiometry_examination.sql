...
WHEN AUXTMEPR IS NOT NULL THEN AUXTMEPRWHEN AUXTMEPR IS NULL THEN NULL 
ELSE NULL 
 END as middle_ear_pressure_tymp_rt_ear_in_dapa,
WHEN AUXTPVR IS NOT NULL THEN AUXTPVRWHEN AUXTPVR IS NULL THEN NULL 
ELSE NULL 
 END as physical_volume_tymp_right_ear_in_cc,
WHEN AUXTWIDR IS NOT NULL THEN AUXTWIDRWHEN AUXTWIDR IS NULL THEN NULL 
ELSE NULL 
 END as tympanometric_width_right_ear,
WHEN AUXTCOMR IS NOT NULL THEN AUXTCOMRWHEN AUXTCOMR IS NULL THEN NULL 
ELSE NULL 
 END as compliance_tympanometry_right_ear,
WHEN AUXTMEPL IS NOT NULL THEN AUXTMEPLWHEN AUXTMEPL IS NULL THEN NULL 
ELSE NULL 
 END as middle_ear_pressure_tymp_left_in_dapa,
WHEN AUXTPVL IS NOT NULL THEN AUXTPVLWHEN AUXTPVL IS NULL THEN NULL 
ELSE NULL 
 END as physical_volume_tymp_left_ear_in_cc,
WHEN AUXTWIDL IS NOT NULL THEN AUXTWIDLWHEN AUXTWIDL IS NULL THEN NULL 
ELSE NULL 
 END as tympanometric_width_left_ear,
WHEN AUXTCOML IS NOT NULL THEN AUXTCOMLWHEN AUXTCOML IS NULL THEN NULL 
ELSE NULL 
...
WHEN AUXU1K1R IS NOT NULL THEN AUXU1K1RWHEN AUXU1K1R IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_1000hz_db,
WHEN AUXU500R IS NOT NULL THEN AUXU500RWHEN AUXU500R IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_500hz_db,
WHEN AUXU1K2R IS NOT NULL THEN AUXU1K2RWHEN AUXU1K2R IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_1000hz_2nd_read_db,
WHEN AUXU2KR IS NOT NULL THEN AUXU2KRWHEN AUXU2KR IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_2000hz_db,
WHEN AUXU3KR IS NOT NULL THEN AUXU3KRWHEN AUXU3KR IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_3000hz_db,
WHEN AUXU4KR IS NOT NULL THEN AUXU4KRWHEN AUXU4KR IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_4000hz_db,
WHEN AUXU6KR IS NOT NULL THEN AUXU6KRWHEN AUXU6KR IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_6000hz_db,
WHEN AUXU8KR IS NOT NULL THEN AUXU8KRWHEN AUXU8KR IS NULL THEN NULL 
ELSE NULL 
 END as right_threshold_8000hz_db,
WHEN AUXU1K1L IS NOT NULL THEN AUXU1K1LWHEN AUXU1K1L IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_1000hz_db,
WHEN AUXU500L IS NOT NULL THEN AUXU500LWHEN AUXU500L IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_500hz_db,
WHEN AUXU1K2L IS NOT NULL THEN AUXU1K2LWHEN AUXU1K2L IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_1000hz_2nd_read_db,
WHEN AUXU2KL IS NOT NULL THEN AUXU2KLWHEN AUXU2KL IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_2000hz_db,
WHEN AUXU3KL IS NOT NULL THEN AUXU3KLWHEN AUXU3KL IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_3000hz_db,
WHEN AUXU4KL IS NOT NULL THEN AUXU4KLWHEN AUXU4KL IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_4000hz_db,
WHEN AUXU6KL IS NOT NULL THEN AUXU6KLWHEN AUXU6KL IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_6000hz_db,
WHEN AUXU8KL IS NOT NULL THEN AUXU8KLWHEN AUXU8KL IS NULL THEN NULL 
ELSE NULL 
 END as left_threshold_8000hz_db,
WHEN AUXR1K1R IS NOT NULL THEN AUXR1K1RWHEN AUXR1K1R IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_1000hz_db,
WHEN AUXR5CR IS NOT NULL THEN AUXR5CRWHEN AUXR5CR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_500hz_db,
WHEN AUXR1K2R IS NOT NULL THEN AUXR1K2RWHEN AUXR1K2R IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_1000hz_2nd_read,
WHEN AUXR2KR IS NOT NULL THEN AUXR2KRWHEN AUXR2KR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_2000hz_db,
WHEN AUXR3KR IS NOT NULL THEN AUXR3KRWHEN AUXR3KR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_3000hz_db,
WHEN AUXR4KR IS NOT NULL THEN AUXR4KRWHEN AUXR4KR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_4000hz_db,
WHEN AUXR6KR IS NOT NULL THEN AUXR6KRWHEN AUXR6KR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_6000hz_db,
WHEN AUXR8KR IS NOT NULL THEN AUXR8KRWHEN AUXR8KR IS NULL THEN NULL 
ELSE NULL 
 END as right_retest_threshold_8000hz_db,
WHEN AUXR1K1L IS NOT NULL THEN AUXR1K1LWHEN AUXR1K1L IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_1000hz_db,
WHEN AUXR5CL IS NOT NULL THEN AUXR5CLWHEN AUXR5CL IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_500hz_db,
WHEN AUXR1K2L IS NOT NULL THEN AUXR1K2LWHEN AUXR1K2L IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_1000hz_2nd_read,
WHEN AUXR2KL IS NOT NULL THEN AUXR2KLWHEN AUXR2KL IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_2000hz_db,
WHEN AUXR3KL IS NOT NULL THEN AUXR3KLWHEN AUXR3KL IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_3000hz_db,
WHEN AUXR4KL IS NOT NULL THEN AUXR4KLWHEN AUXR4KL IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_4000hz_db,
WHEN AUXR6KL IS NOT NULL THEN AUXR6KLWHEN AUXR6KL IS NULL THEN NULL 
ELSE NULL 
 END as left_retest_threshold_6000hz_db,
WHEN AUXR8KL IS NOT NULL THEN AUXR8KLWHEN AUXR8KL IS NULL THEN NULL 
ELSE NULL 
