...
WHEN OHQ780A = '99' THEN 'Dont know' 
...
WHEN OHQ555G = '9' THEN 'Dont know' 
WHEN OHQ555G IS NULL THEN NULL 
ELSE NULL 
 END as age_started_brushing_teeth, 

CASE
        WHEN OHQ555Q IS NOT NULL THEN SAFE_CAST(OHQ555Q AS FLOAT64) 
WHEN OHQ555Q IS NOT NULL THEN SAFE_CAST(OHQ555Q AS FLOAT64) 
WHEN OHQ555Q IS NOT NULL THEN SAFE_CAST(OHQ555Q AS FLOAT64) 
...
WHEN OHQ560G = '9' THEN 'Dont know' 
WHEN OHQ560G IS NULL THEN NULL 
ELSE NULL 
 END as age_started_using_toothpaste, 

CASE
        WHEN OHQ560Q IS NOT NULL THEN SAFE_CAST(OHQ560Q AS FLOAT64) 
WHEN OHQ560Q IS NOT NULL THEN SAFE_CAST(OHQ560Q AS FLOAT64) 
WHEN OHQ560Q IS NOT NULL THEN SAFE_CAST(OHQ560Q AS FLOAT64) 
...
WHEN OHQ566 = '9' THEN 'Dont know' 
WHEN OHQ566 IS NULL THEN NULL 
ELSE NULL 
 END as received_rx_fluoride_drops_or_tablets, 

CASE
        WHEN OHQ571Q IS NOT NULL THEN SAFE_CAST(OHQ571Q AS FLOAT64) 
WHEN OHQ571Q IS NOT NULL THEN SAFE_CAST(OHQ571Q AS FLOAT64) 
WHEN OHQ571Q IS NOT NULL THEN SAFE_CAST(OHQ571Q AS FLOAT64) 
...
WHEN OHQ576G = '9' THEN 'Dont know' 
WHEN OHQ576G IS NULL THEN NULL 
ELSE NULL 
 END as age_stopped_taking_prescription_fluoride, 

CASE
        WHEN OHQ576Q IS NOT NULL THEN SAFE_CAST(OHQ576Q AS FLOAT64) 
WHEN OHQ576Q IS NOT NULL THEN SAFE_CAST(OHQ576Q AS FLOAT64) 
WHEN OHQ576Q IS NOT NULL THEN SAFE_CAST(OHQ576Q AS FLOAT64) 
...
WHEN OHQ848Q = '99' THEN 'Dont know' 
...
WHEN OHQ860 = '9' THEN 'Dont know' 
WHEN OHQ860 IS NULL THEN NULL 
ELSE NULL 
 END as ever_been_told_of_bone_loss_around_teeth, 

CASE
        WHEN OHQ870 IS NOT NULL THEN SAFE_CAST(OHQ870 AS FLOAT64) 
WHEN OHQ870 IS NOT NULL THEN SAFE_CAST(OHQ870 AS FLOAT64) 
WHEN OHQ870 IS NOT NULL THEN SAFE_CAST(OHQ870 AS FLOAT64) 
