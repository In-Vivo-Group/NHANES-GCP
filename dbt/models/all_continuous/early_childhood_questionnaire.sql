...
CASE
        WHEN ECD010 IS NOT NULL THEN ECD010 
WHEN ECD010 IS NOT NULL THEN ECD010 
WHEN ECD010 IS NOT NULL THEN ECD010 
WHEN ECD010 IS NOT NULL THEN ECD010 
WHEN ECD010 IS NOT NULL THEN ECD010 
...
WHEN ECQ020 = 9 THEN 'Dont know' 
WHEN ECQ020 IS NULL THEN NULL 
ELSE NULL 
 END as mother_smoked_when_pregnant, 

CASE
        WHEN ECD070A IS NOT NULL THEN ECD070A 
WHEN ECD070A IS NOT NULL THEN ECD070A 
WHEN ECD070A IS NOT NULL THEN ECD070A 
WHEN ECD070A IS NOT NULL THEN ECD070A 
WHEN ECD070A IS NOT NULL THEN ECD070A 
...
CASE
        WHEN ECD070B IS NOT NULL THEN ECD070B 
WHEN ECD070B IS NOT NULL THEN ECD070B 
WHEN ECD070B IS NOT NULL THEN ECD070B 
