...
WHEN RXDDRUG = '99999' THEN 'Dont know' 
...
CASE
        WHEN RXDDAYS IS NOT NULL THEN SAFE_CAST(RXDDAYS AS FLOAT64) 
WHEN RXDDAYS IS NOT NULL THEN SAFE_CAST(RXDDAYS AS FLOAT64) 
WHEN RXDDAYS IS NOT NULL THEN SAFE_CAST(RXDDAYS AS FLOAT64) 
...
WHEN RXDRSC1 = '99999' THEN 'Dont know' 
...
CASE
        WHEN RXDCOUNT IS NOT NULL THEN SAFE_CAST(RXDCOUNT AS FLOAT64) 
