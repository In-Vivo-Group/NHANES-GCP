...
WHEN IND235 = 99 THEN 'Dont know' 
WHEN IND235 IS NULL THEN NULL 
ELSE NULL 
 END as monthly_family_income, 

CASE
        WHEN INDFMMPI IS NOT NULL THEN INDFMMPI 
WHEN INDFMMPI IS NOT NULL THEN INDFMMPI 
...
WHEN INDFMMPC = 9 THEN 'Dont know' 
