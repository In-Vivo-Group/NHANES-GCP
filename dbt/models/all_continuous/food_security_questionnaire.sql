...
WHEN FSD032A = '9' THEN 'Don\'t know' 
...
WHEN FSD032B = '9' THEN 'Don\'t know' 
...
WHEN FSD032C = '9' THEN 'Don\'t know' 
...
WHEN FSD032D = '9' THEN 'Don\'t know' 
...
WHEN FSD032E = '9' THEN 'Don\'t know' 
...
WHEN FSD032F = '9' THEN 'Don\'t know' 
...
WHEN FSQ165 = '9' THEN 'Don\'t know' 
WHEN FSQ165 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_ever_received,
WHEN FSD165N IS NOT NULL THEN SAFE_CAST(FSD165N AS FLOAT64)WHEN FSD165N IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSQ012 = '9' THEN 'Don\'t know' 
WHEN FSQ012 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_receive_in_last_12_months,
WHEN FSD012N IS NOT NULL THEN SAFE_CAST(FSD012N AS FLOAT64)WHEN FSD012N IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSD230 = '9' THEN 'Don\'t know' 
WHEN FSD230 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_currently_receive,
WHEN FSD230N IS NOT NULL THEN SAFE_CAST(FSD230N AS FLOAT64)WHEN FSD230N IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_people_currently_receive,
WHEN FSD795 IS NOT NULL THEN SAFE_CAST(FSD795 AS FLOAT64)WHEN FSD795 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_of_months_received,
WHEN FSD225 IS NOT NULL THEN SAFE_CAST(FSD225 AS FLOAT64)WHEN FSD225 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_time_since_last_received,
WHEN FSD235 IS NOT NULL THEN SAFE_CAST(FSD235 AS FLOAT64)WHEN FSD235 IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSD855 = '9' THEN 'Don\'t know' 
WHEN FSD855 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_anticipate_will_receive,
WHEN FSD860 IS NOT NULL THEN SAFE_CAST(FSD860 AS FLOAT64)WHEN FSD860 IS NULL THEN NULL 
ELSE NULL 
 END as hh_fs_benefit_time_will_receive,
WHEN FSQ865 IS NOT NULL THEN SAFE_CAST(FSQ865 AS FLOAT64)WHEN FSQ865 IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSQ760 = '9' THEN 'Don\'t know' 
WHEN FSQ760 IS NULL THEN NULL 
ELSE NULL 
 END as hh_wic_benefit_received_in_last_30_days,
WHEN FSD760N IS NOT NULL THEN SAFE_CAST(FSD760N AS FLOAT64)WHEN FSD760N IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSD660ZC = '9' THEN 'Don\'t know' 
...
WHEN FSD680 = '9' THEN 'Don\'t know' 
WHEN FSD680 IS NULL THEN NULL 
ELSE NULL 
 END as ch_wic_benefit_received_b_w_1_4_yrs_old,
WHEN FSD670ZC IS NOT NULL THEN SAFE_CAST(FSD670ZC AS FLOAT64)WHEN FSD670ZC IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSQ690 = '9' THEN 'Don\'t know' 
WHEN FSQ690 IS NULL THEN NULL 
ELSE NULL 
 END as ch_wic_benefit_mom_received_while_preg,
WHEN FSQ695 IS NOT NULL THEN SAFE_CAST(FSQ695 AS FLOAT64)WHEN FSQ695 IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSD652ZW = '9' THEN 'Don\'t know' 
WHEN FSD652ZW IS NULL THEN NULL 
ELSE NULL 
 END as wm_wic_benefit_receive_in_latest_preg,
WHEN FSD672ZW IS NOT NULL THEN SAFE_CAST(FSD672ZW AS FLOAT64)WHEN FSD672ZW IS NULL THEN NULL 
ELSE NULL 
...
WHEN FSD652CW = '9' THEN 'Don\'t know' 
...
WHEN FSD660ZW = '9' THEN 'Don\'t know' 
