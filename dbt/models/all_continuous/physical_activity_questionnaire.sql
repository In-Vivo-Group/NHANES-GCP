...
WHEN PAQ605 = '9' THEN 'Dont know' 
WHEN PAQ605 IS NULL THEN NULL 
ELSE NULL 
 END as vigorous_work_activity, 

CASE
        WHEN PAQ610 IS NOT NULL THEN SAFE_CAST(PAQ610 AS FLOAT64) 
WHEN PAQ610 IS NOT NULL THEN SAFE_CAST(PAQ610 AS FLOAT64) 
WHEN PAQ610 IS NOT NULL THEN SAFE_CAST(PAQ610 AS FLOAT64) 
...
CASE
        WHEN PAD615 IS NOT NULL THEN SAFE_CAST(PAD615 AS FLOAT64) 
WHEN PAD615 IS NOT NULL THEN SAFE_CAST(PAD615 AS FLOAT64) 
WHEN PAD615 IS NOT NULL THEN SAFE_CAST(PAD615 AS FLOAT64) 
...
WHEN PAQ620 = '9' THEN 'Dont know' 
WHEN PAQ620 IS NULL THEN NULL 
ELSE NULL 
 END as moderate_work_activity, 

CASE
        WHEN PAQ625 IS NOT NULL THEN SAFE_CAST(PAQ625 AS FLOAT64) 
WHEN PAQ625 IS NOT NULL THEN SAFE_CAST(PAQ625 AS FLOAT64) 
WHEN PAQ625 IS NOT NULL THEN SAFE_CAST(PAQ625 AS FLOAT64) 
...
CASE
        WHEN PAD630 IS NOT NULL THEN SAFE_CAST(PAD630 AS FLOAT64) 
WHEN PAD630 IS NOT NULL THEN SAFE_CAST(PAD630 AS FLOAT64) 
WHEN PAD630 IS NOT NULL THEN SAFE_CAST(PAD630 AS FLOAT64) 
...
WHEN PAQ635 = '9' THEN 'Dont know' 
WHEN PAQ635 IS NULL THEN NULL 
ELSE NULL 
 END as walk_or_bicycle, 

CASE
        WHEN PAQ640 IS NOT NULL THEN SAFE_CAST(PAQ640 AS FLOAT64) 
WHEN PAQ640 IS NOT NULL THEN SAFE_CAST(PAQ640 AS FLOAT64) 
WHEN PAQ640 IS NOT NULL THEN SAFE_CAST(PAQ640 AS FLOAT64) 
...
CASE
        WHEN PAD645 IS NOT NULL THEN SAFE_CAST(PAD645 AS FLOAT64) 
WHEN PAD645 IS NOT NULL THEN SAFE_CAST(PAD645 AS FLOAT64) 
WHEN PAD645 IS NOT NULL THEN SAFE_CAST(PAD645 AS FLOAT64) 
...
WHEN PAQ650 = '9' THEN 'Dont know' 
WHEN PAQ650 IS NULL THEN NULL 
ELSE NULL 
 END as vigorous_recreational_activities, 

CASE
        WHEN PAQ655 IS NOT NULL THEN SAFE_CAST(PAQ655 AS FLOAT64) 
WHEN PAQ655 IS NOT NULL THEN SAFE_CAST(PAQ655 AS FLOAT64) 
WHEN PAQ655 IS NOT NULL THEN SAFE_CAST(PAQ655 AS FLOAT64) 
...
CASE
        WHEN PAD660 IS NOT NULL THEN SAFE_CAST(PAD660 AS FLOAT64) 
WHEN PAD660 IS NOT NULL THEN SAFE_CAST(PAD660 AS FLOAT64) 
WHEN PAD660 IS NOT NULL THEN SAFE_CAST(PAD660 AS FLOAT64) 
...
WHEN PAQ665 = '9' THEN 'Dont know' 
WHEN PAQ665 IS NULL THEN NULL 
ELSE NULL 
 END as moderate_recreational_activities, 

CASE
        WHEN PAQ670 IS NOT NULL THEN SAFE_CAST(PAQ670 AS FLOAT64) 
WHEN PAQ670 IS NOT NULL THEN SAFE_CAST(PAQ670 AS FLOAT64) 
WHEN PAQ670 IS NOT NULL THEN SAFE_CAST(PAQ670 AS FLOAT64) 
...
CASE
        WHEN PAD675 IS NOT NULL THEN SAFE_CAST(PAD675 AS FLOAT64) 
WHEN PAD675 IS NOT NULL THEN SAFE_CAST(PAD675 AS FLOAT64) 
WHEN PAD675 IS NOT NULL THEN SAFE_CAST(PAD675 AS FLOAT64) 
...
CASE
        WHEN PAD680 IS NOT NULL THEN SAFE_CAST(PAD680 AS FLOAT64) 
WHEN PAD680 IS NOT NULL THEN SAFE_CAST(PAD680 AS FLOAT64) 
WHEN PAD680 IS NOT NULL THEN SAFE_CAST(PAD680 AS FLOAT64) 
