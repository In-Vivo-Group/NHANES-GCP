...
WHEN DBQ095Z = 4 THEN 'Doesnt use or add salt products at the table' 
WHEN DBQ095Z = 91 THEN 'Other' 
WHEN DBQ095Z = 99 THEN 'Dont know' 
...
WHEN DRQSPREP = 9 THEN 'Dont know' 
...
WHEN DRQSDIET = 9 THEN 'Dont know' 
...
WHEN DR1TWSZ = '4' THEN 'Dont drink tap water' 
WHEN DR1TWSZ = '91' THEN 'Other' 
WHEN DR1TWSZ = '99' THEN 'Dont know' 
...
CASE
        WHEN DRD350AQ IS NOT NULL THEN DRD350AQ 
...
CASE
        WHEN DRD350BQ IS NOT NULL THEN DRD350BQ 
...
CASE
        WHEN DRD350CQ IS NOT NULL THEN DRD350CQ 
...
CASE
        WHEN DRD350DQ IS NOT NULL THEN DRD350DQ 
...
CASE
        WHEN DRD350EQ IS NOT NULL THEN DRD350EQ 
...
CASE
        WHEN DRD350FQ IS NOT NULL THEN DRD350FQ 
...
CASE
        WHEN DRD350GQ IS NOT NULL THEN DRD350GQ 
...
CASE
        WHEN DRD350HQ IS NOT NULL THEN DRD350HQ 
...
CASE
        WHEN DRD350IQ IS NOT NULL THEN DRD350IQ 
...
CASE
        WHEN DRD350JQ IS NOT NULL THEN DRD350JQ 
...
CASE
        WHEN DRD370AQ IS NOT NULL THEN DRD370AQ 
...
CASE
        WHEN DRD370BQ IS NOT NULL THEN DRD370BQ 
...
CASE
        WHEN DRD370CQ IS NOT NULL THEN DRD370CQ 
...
CASE
        WHEN DRD370DQ IS NOT NULL THEN DRD370DQ 
...
CASE
        WHEN DRD370EQ IS NOT NULL THEN DRD370EQ 
...
CASE
        WHEN DRD370FQ IS NOT NULL THEN DRD370FQ 
...
CASE
        WHEN DRD370GQ IS NOT NULL THEN DRD370GQ 
...
CASE
        WHEN DRD370HQ IS NOT NULL THEN DRD370HQ 
...
CASE
        WHEN DRD370IQ IS NOT NULL THEN DRD370IQ 
...
CASE
        WHEN DRD370JQ IS NOT NULL THEN DRD370JQ 
...
CASE
        WHEN DRD370KQ IS NOT NULL THEN DRD370KQ 
...
CASE
        WHEN DRD370LQ IS NOT NULL THEN DRD370LQ 
...
CASE
        WHEN DRD370MQ IS NOT NULL THEN DRD370MQ 
...
CASE
        WHEN DRD370NQ IS NOT NULL THEN DRD370NQ 
...
CASE
        WHEN DRD370OQ IS NOT NULL THEN DRD370OQ 
...
CASE
        WHEN DRD370PQ IS NOT NULL THEN DRD370PQ 
...
CASE
        WHEN DRD370QQ IS NOT NULL THEN DRD370QQ 
...
CASE
        WHEN DRD370RQ IS NOT NULL THEN DRD370RQ 
...
CASE
        WHEN DRD370SQ IS NOT NULL THEN DRD370SQ 
...
CASE
        WHEN DRD370TQ IS NOT NULL THEN DRD370TQ 
...
CASE
        WHEN DRD370UQ IS NOT NULL THEN DRD370UQ 
