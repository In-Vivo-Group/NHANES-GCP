...
WHEN DS2ACTSS IS NOT NULL THEN DS2ACTSSWHEN DS2ACTSS IS NULL THEN NULL 
ELSE NULL 
 END as reported_serving_size_label_serving_size,
WHEN DS2IKCAL IS NOT NULL THEN DS2IKCALWHEN DS2IKCAL IS NULL THEN NULL 
ELSE NULL 
 END as energy_kcal,
WHEN DS2IPROT IS NOT NULL THEN DS2IPROTWHEN DS2IPROT IS NULL THEN NULL 
ELSE NULL 
 END as protein_gm,
WHEN DS2ICARB IS NOT NULL THEN DS2ICARBWHEN DS2ICARB IS NULL THEN NULL 
ELSE NULL 
 END as carbohydrate_gm,
WHEN DS2ISUGR IS NOT NULL THEN DS2ISUGRWHEN DS2ISUGR IS NULL THEN NULL 
ELSE NULL 
 END as total_sugars_gm,
WHEN DS2IFIBE IS NOT NULL THEN DS2IFIBEWHEN DS2IFIBE IS NULL THEN NULL 
ELSE NULL 
 END as dietary_fiber_gm,
WHEN DS2ITFAT IS NOT NULL THEN DS2ITFATWHEN DS2ITFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_fat_gm,
WHEN DS2ISFAT IS NOT NULL THEN DS2ISFATWHEN DS2ISFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_saturated_fatty_acids_gm,
WHEN DS2IMFAT IS NOT NULL THEN DS2IMFATWHEN DS2IMFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_monounsaturated_fatty_acids_gm,
WHEN DS2IPFAT IS NOT NULL THEN DS2IPFATWHEN DS2IPFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_polyunsaturated_fatty_acids_gm,
WHEN DS2ICHOL IS NOT NULL THEN DS2ICHOLWHEN DS2ICHOL IS NULL THEN NULL 
ELSE NULL 
 END as cholesterol_mg,
WHEN DS2ILYCO IS NOT NULL THEN DS2ILYCOWHEN DS2ILYCO IS NULL THEN NULL 
ELSE NULL 
 END as lycopene_mcg,
WHEN DS2ILZ IS NOT NULL THEN DS2ILZWHEN DS2ILZ IS NULL THEN NULL 
ELSE NULL 
 END as lutein_zeaxanthin_mcg,
WHEN DS2IVB1 IS NOT NULL THEN DS2IVB1WHEN DS2IVB1 IS NULL THEN NULL 
ELSE NULL 
 END as thiamin_vitamin_b1_mg,
WHEN DS2IVB2 IS NOT NULL THEN DS2IVB2WHEN DS2IVB2 IS NULL THEN NULL 
ELSE NULL 
 END as riboflavin_vitamin_b2_mg,
WHEN DS2INIAC IS NOT NULL THEN DS2INIACWHEN DS2INIAC IS NULL THEN NULL 
ELSE NULL 
 END as niacin_mg,
WHEN DS2IVB6 IS NOT NULL THEN DS2IVB6WHEN DS2IVB6 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b6_mg,
WHEN DS2IFA IS NOT NULL THEN DS2IFAWHEN DS2IFA IS NULL THEN NULL 
ELSE NULL 
 END as folic_acid_mcg,
WHEN DS2IFDFE IS NOT NULL THEN DS2IFDFEWHEN DS2IFDFE IS NULL THEN NULL 
ELSE NULL 
 END as folate_dfe_mcg,
WHEN DS2ICHL IS NOT NULL THEN DS2ICHLWHEN DS2ICHL IS NULL THEN NULL 
ELSE NULL 
 END as total_choline_mg,
WHEN DS2IVB12 IS NOT NULL THEN DS2IVB12WHEN DS2IVB12 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b12_mcg,
WHEN DS2IVC IS NOT NULL THEN DS2IVCWHEN DS2IVC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_c_mg,
WHEN DS2IVK IS NOT NULL THEN DS2IVKWHEN DS2IVK IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_k_mcg,
WHEN DS2IVD IS NOT NULL THEN DS2IVDWHEN DS2IVD IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_d_d2_d3_mcg,
WHEN DS2ICALC IS NOT NULL THEN DS2ICALCWHEN DS2ICALC IS NULL THEN NULL 
ELSE NULL 
 END as calcium_mg,
WHEN DS2IPHOS IS NOT NULL THEN DS2IPHOSWHEN DS2IPHOS IS NULL THEN NULL 
ELSE NULL 
 END as phosphorus_mg,
WHEN DS2IMAGN IS NOT NULL THEN DS2IMAGNWHEN DS2IMAGN IS NULL THEN NULL 
ELSE NULL 
 END as magnesium_mg,
WHEN DS2IIRON IS NOT NULL THEN DS2IIRONWHEN DS2IIRON IS NULL THEN NULL 
ELSE NULL 
 END as iron_mg,
WHEN DS2IZINC IS NOT NULL THEN DS2IZINCWHEN DS2IZINC IS NULL THEN NULL 
ELSE NULL 
 END as zinc_mg,
WHEN DS2ICOPP IS NOT NULL THEN DS2ICOPPWHEN DS2ICOPP IS NULL THEN NULL 
ELSE NULL 
 END as copper_mg,
WHEN DS2ISODI IS NOT NULL THEN DS2ISODIWHEN DS2ISODI IS NULL THEN NULL 
ELSE NULL 
 END as sodium_mg,
WHEN DS2IPOTA IS NOT NULL THEN DS2IPOTAWHEN DS2IPOTA IS NULL THEN NULL 
ELSE NULL 
 END as potassium_mg,
WHEN DS2ISELE IS NOT NULL THEN DS2ISELEWHEN DS2ISELE IS NULL THEN NULL 
ELSE NULL 
 END as selenium_mcg,
WHEN DS2ICAFF IS NOT NULL THEN DS2ICAFFWHEN DS2ICAFF IS NULL THEN NULL 
ELSE NULL 
 END as caffeine_mg,
