...
WHEN WTSSAJ2Y IS NOT NULL THEN WTSSAJ2YWHEN WTSSAJ2Y IS NULL THEN NULL 
ELSE NULL 
 END as surplus_specimen_a_17_18_2_year_weights,
WHEN SSHMFA IS NOT NULL THEN SSHMFAWHEN SSHMFA IS NULL THEN NULL 
ELSE NULL 
...
WHEN SSHMFG IS NOT NULL THEN SSHMFGWHEN SSHMFG IS NULL THEN NULL 
ELSE NULL 
...
WHEN SSMUCA IS NOT NULL THEN SSMUCAWHEN SSMUCA IS NULL THEN NULL 
ELSE NULL 
...
WHEN SSN2FG IS NOT NULL THEN SSN2FGWHEN SSN2FG IS NULL THEN NULL 
ELSE NULL 
...
WHEN SSPHMA IS NOT NULL THEN SSPHMAWHEN SSPHMA IS NULL THEN NULL 
ELSE NULL 
