...
CASE
        WHEN URXUBA IS NOT NULL THEN URXUBA 
...
CASE
        WHEN URXUCD IS NOT NULL THEN URXUCD 
...
CASE
        WHEN URXUCO IS NOT NULL THEN URXUCO 
...
CASE
        WHEN URXUCS IS NOT NULL THEN URXUCS 
...
CASE
        WHEN URXUMO IS NOT NULL THEN URXUMO 
...
CASE
        WHEN URXUMN IS NOT NULL THEN SAFE_CAST(URXUMN AS FLOAT64) 
...
CASE
        WHEN URXUPB IS NOT NULL THEN URXUPB 
...
CASE
        WHEN URXUSB IS NOT NULL THEN URXUSB 
...
CASE
        WHEN URXUSN IS NOT NULL THEN SAFE_CAST(URXUSN AS FLOAT64) 
...
CASE
        WHEN URXUTL IS NOT NULL THEN URXUTL 
...
CASE
        WHEN URXUTU IS NOT NULL THEN URXUTU 
