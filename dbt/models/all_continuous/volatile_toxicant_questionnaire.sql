...
WHEN VTQ241A = 9 THEN 'Dont know' 
WHEN VTQ241A IS NULL THEN NULL 
ELSE NULL 
 END as did_you_cook_with_natural_gas, 

CASE
        WHEN VTD241B IS NOT NULL THEN VTD241B 
WHEN VTD241B IS NOT NULL THEN VTD241B 
WHEN VTD241B IS NOT NULL THEN VTD241B 
WHEN VTD241B IS NOT NULL THEN VTD241B 
