...
CASE
        WHEN DBD041 IS NOT NULL THEN SAFE_CAST(DBD041 AS FLOAT64) 
WHEN DBD041 IS NOT NULL THEN SAFE_CAST(DBD041 AS FLOAT64) 
WHEN DBD041 IS NOT NULL THEN SAFE_CAST(DBD041 AS FLOAT64) 
WHEN DBD041 IS NOT NULL THEN SAFE_CAST(DBD041 AS FLOAT64) 
WHEN DBD041 IS NOT NULL THEN SAFE_CAST(DBD041 AS FLOAT64) 
...
CASE
        WHEN DBD050 IS NOT NULL THEN DBD050 
WHEN DBD050 IS NOT NULL THEN DBD050 
WHEN DBD050 IS NOT NULL THEN DBD050 
WHEN DBD050 IS NOT NULL THEN DBD050 
WHEN DBD050 IS NOT NULL THEN DBD050 
...
CASE
        WHEN DBD055 IS NOT NULL THEN SAFE_CAST(DBD055 AS FLOAT64) 
WHEN DBD055 IS NOT NULL THEN SAFE_CAST(DBD055 AS FLOAT64) 
WHEN DBD055 IS NOT NULL THEN SAFE_CAST(DBD055 AS FLOAT64) 
WHEN DBD055 IS NOT NULL THEN SAFE_CAST(DBD055 AS FLOAT64) 
WHEN DBD055 IS NOT NULL THEN SAFE_CAST(DBD055 AS FLOAT64) 
...
CASE
        WHEN DBD061 IS NOT NULL THEN SAFE_CAST(DBD061 AS FLOAT64) 
WHEN DBD061 IS NOT NULL THEN SAFE_CAST(DBD061 AS FLOAT64) 
WHEN DBD061 IS NOT NULL THEN SAFE_CAST(DBD061 AS FLOAT64) 
WHEN DBD061 IS NOT NULL THEN SAFE_CAST(DBD061 AS FLOAT64) 
WHEN DBD061 IS NOT NULL THEN SAFE_CAST(DBD061 AS FLOAT64) 
...
WHEN DBQ073A = '99' THEN 'Dont know' 
...
WHEN DBQ223A = '99' THEN 'Dont know' 
...
CASE
        WHEN DBQ229 = '1' THEN '{Ive/Hes/Shes} been a regular milk drinker for most or all of {my/his/her} life, including {my/his/her} childhood' 
WHEN DBQ229 = '2' THEN '{Ive/Hes/Shes} never been a regular milk drinker;' 
WHEN DBQ229 = '3' THEN '{My/His/Her} milk drinking has varied over {my/his/her} life-sometimes {Ive/hes/shes} been a regular milk drinker' 
WHEN DBQ229 = '7' THEN 'Refused' 
WHEN DBQ229 = '9' THEN 'Dont know' 
...
WHEN DBQ424 = '9' THEN 'Dont know' 
WHEN DBQ424 IS NULL THEN NULL 
ELSE NULL 
 END as summer_program_meal_free_reduced_price, 

CASE
        WHEN DBD895 IS NOT NULL THEN SAFE_CAST(DBD895 AS FLOAT64) 
WHEN DBD895 IS NOT NULL THEN SAFE_CAST(DBD895 AS FLOAT64) 
WHEN DBD895 IS NOT NULL THEN SAFE_CAST(DBD895 AS FLOAT64) 
WHEN DBD895 IS NOT NULL THEN SAFE_CAST(DBD895 AS FLOAT64) 
WHEN DBD895 IS NOT NULL THEN SAFE_CAST(DBD895 AS FLOAT64) 
...
CASE
        WHEN DBD900 IS NOT NULL THEN SAFE_CAST(DBD900 AS FLOAT64) 
WHEN DBD900 IS NOT NULL THEN SAFE_CAST(DBD900 AS FLOAT64) 
WHEN DBD900 IS NOT NULL THEN SAFE_CAST(DBD900 AS FLOAT64) 
WHEN DBD900 IS NOT NULL THEN SAFE_CAST(DBD900 AS FLOAT64) 
WHEN DBD900 IS NOT NULL THEN SAFE_CAST(DBD900 AS FLOAT64) 
...
CASE
        WHEN DBD905 IS NOT NULL THEN SAFE_CAST(DBD905 AS FLOAT64) 
WHEN DBD905 IS NOT NULL THEN SAFE_CAST(DBD905 AS FLOAT64) 
WHEN DBD905 IS NOT NULL THEN SAFE_CAST(DBD905 AS FLOAT64) 
WHEN DBD905 IS NOT NULL THEN SAFE_CAST(DBD905 AS FLOAT64) 
WHEN DBD905 IS NOT NULL THEN SAFE_CAST(DBD905 AS FLOAT64) 
...
CASE
        WHEN DBD910 IS NOT NULL THEN SAFE_CAST(DBD910 AS FLOAT64) 
WHEN DBD910 IS NOT NULL THEN SAFE_CAST(DBD910 AS FLOAT64) 
WHEN DBD910 IS NOT NULL THEN SAFE_CAST(DBD910 AS FLOAT64) 
WHEN DBD910 IS NOT NULL THEN SAFE_CAST(DBD910 AS FLOAT64) 
WHEN DBD910 IS NOT NULL THEN SAFE_CAST(DBD910 AS FLOAT64) 
