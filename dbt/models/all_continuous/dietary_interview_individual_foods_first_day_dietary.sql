...
WHEN DR1ILINE IS NOT NULL THEN DR1ILINEWHEN DR1ILINE IS NULL THEN NULL 
ELSE NULL 
...
WHEN DR1CCMNM IS NOT NULL THEN DR1CCMNMWHEN DR1CCMNM IS NULL THEN NULL 
ELSE NULL 
...
WHEN DR1_020 IS NOT NULL THEN DR1_020WHEN DR1_020 IS NULL THEN NULL 
ELSE NULL 
...
WHEN DR1IFDCD IS NOT NULL THEN DR1IFDCDWHEN DR1IFDCD IS NULL THEN NULL 
ELSE NULL 
 END as usda_food_code,
WHEN DR1IGRMS IS NOT NULL THEN DR1IGRMSWHEN DR1IGRMS IS NULL THEN NULL 
ELSE NULL 
 END as grams,
WHEN DR1IKCAL IS NOT NULL THEN DR1IKCALWHEN DR1IKCAL IS NULL THEN NULL 
ELSE NULL 
 END as energy_kcal,
WHEN DR1IPROT IS NOT NULL THEN DR1IPROTWHEN DR1IPROT IS NULL THEN NULL 
ELSE NULL 
 END as protein_gm,
WHEN DR1ICARB IS NOT NULL THEN DR1ICARBWHEN DR1ICARB IS NULL THEN NULL 
ELSE NULL 
 END as carbohydrate_gm,
WHEN DR1ISUGR IS NOT NULL THEN DR1ISUGRWHEN DR1ISUGR IS NULL THEN NULL 
ELSE NULL 
 END as total_sugars_gm,
WHEN DR1IFIBE IS NOT NULL THEN DR1IFIBEWHEN DR1IFIBE IS NULL THEN NULL 
ELSE NULL 
 END as dietary_fiber_gm,
WHEN DR1ITFAT IS NOT NULL THEN DR1ITFATWHEN DR1ITFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_fat_gm,
WHEN DR1ISFAT IS NOT NULL THEN DR1ISFATWHEN DR1ISFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_saturated_fatty_acids_gm,
WHEN DR1IMFAT IS NOT NULL THEN DR1IMFATWHEN DR1IMFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_monounsaturated_fatty_acids_gm,
WHEN DR1IPFAT IS NOT NULL THEN DR1IPFATWHEN DR1IPFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_polyunsaturated_fatty_acids_gm,
WHEN DR1ICHOL IS NOT NULL THEN DR1ICHOLWHEN DR1ICHOL IS NULL THEN NULL 
ELSE NULL 
 END as cholesterol_mg,
WHEN DR1IATOC IS NOT NULL THEN DR1IATOCWHEN DR1IATOC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_e_as_alpha_tocopherol_mg,
WHEN DR1IATOA IS NOT NULL THEN DR1IATOAWHEN DR1IATOA IS NULL THEN NULL 
ELSE NULL 
 END as added_alpha_tocopherol_vitamin_e_mg,
WHEN DR1IRET IS NOT NULL THEN DR1IRETWHEN DR1IRET IS NULL THEN NULL 
ELSE NULL 
 END as retinol_mcg,
WHEN DR1IVARA IS NOT NULL THEN DR1IVARAWHEN DR1IVARA IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_a_rae_mcg,
WHEN DR1IACAR IS NOT NULL THEN DR1IACARWHEN DR1IACAR IS NULL THEN NULL 
ELSE NULL 
 END as alpha_carotene_mcg,
WHEN DR1IBCAR IS NOT NULL THEN DR1IBCARWHEN DR1IBCAR IS NULL THEN NULL 
ELSE NULL 
 END as beta_carotene_mcg,
WHEN DR1ICRYP IS NOT NULL THEN DR1ICRYPWHEN DR1ICRYP IS NULL THEN NULL 
ELSE NULL 
 END as beta_cryptoxanthin_mcg,
WHEN DR1ILYCO IS NOT NULL THEN DR1ILYCOWHEN DR1ILYCO IS NULL THEN NULL 
ELSE NULL 
 END as lycopene_mcg,
WHEN DR1ILZ IS NOT NULL THEN DR1ILZWHEN DR1ILZ IS NULL THEN NULL 
ELSE NULL 
 END as lutein_zeaxanthin_mcg,
WHEN DR1IVB1 IS NOT NULL THEN DR1IVB1WHEN DR1IVB1 IS NULL THEN NULL 
ELSE NULL 
 END as thiamin_vitamin_b1_mg,
WHEN DR1IVB2 IS NOT NULL THEN DR1IVB2WHEN DR1IVB2 IS NULL THEN NULL 
ELSE NULL 
 END as riboflavin_vitamin_b2_mg,
WHEN DR1INIAC IS NOT NULL THEN DR1INIACWHEN DR1INIAC IS NULL THEN NULL 
ELSE NULL 
 END as niacin_mg,
WHEN DR1IVB6 IS NOT NULL THEN DR1IVB6WHEN DR1IVB6 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b6_mg,
WHEN DR1IFOLA IS NOT NULL THEN DR1IFOLAWHEN DR1IFOLA IS NULL THEN NULL 
ELSE NULL 
 END as total_folate_mcg,
WHEN DR1IFA IS NOT NULL THEN DR1IFAWHEN DR1IFA IS NULL THEN NULL 
ELSE NULL 
 END as folic_acid_mcg,
WHEN DR1IFF IS NOT NULL THEN DR1IFFWHEN DR1IFF IS NULL THEN NULL 
ELSE NULL 
 END as food_folate_mcg,
WHEN DR1IFDFE IS NOT NULL THEN DR1IFDFEWHEN DR1IFDFE IS NULL THEN NULL 
ELSE NULL 
...
WHEN DR1IVB12 IS NOT NULL THEN DR1IVB12WHEN DR1IVB12 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b12_mcg,
WHEN DR1IB12A IS NOT NULL THEN DR1IB12AWHEN DR1IB12A IS NULL THEN NULL 
ELSE NULL 
 END as added_vitamin_b12_mcg,
WHEN DR1IVC IS NOT NULL THEN DR1IVCWHEN DR1IVC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_c_mg,
WHEN DR1IVD IS NOT NULL THEN SAFE_CAST(DR1IVD AS FLOAT64)WHEN DR1IVD IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_d_d2_d3_mcg,
WHEN DR1IVK IS NOT NULL THEN DR1IVKWHEN DR1IVK IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_k_mcg,
WHEN DR1ICALC IS NOT NULL THEN DR1ICALCWHEN DR1ICALC IS NULL THEN NULL 
ELSE NULL 
 END as calcium_mg,
WHEN DR1IPHOS IS NOT NULL THEN DR1IPHOSWHEN DR1IPHOS IS NULL THEN NULL 
ELSE NULL 
 END as phosphorus_mg,
WHEN DR1IMAGN IS NOT NULL THEN DR1IMAGNWHEN DR1IMAGN IS NULL THEN NULL 
ELSE NULL 
 END as magnesium_mg,
WHEN DR1IIRON IS NOT NULL THEN DR1IIRONWHEN DR1IIRON IS NULL THEN NULL 
ELSE NULL 
 END as iron_mg,
WHEN DR1IZINC IS NOT NULL THEN DR1IZINCWHEN DR1IZINC IS NULL THEN NULL 
ELSE NULL 
 END as zinc_mg,
WHEN DR1ICOPP IS NOT NULL THEN DR1ICOPPWHEN DR1ICOPP IS NULL THEN NULL 
ELSE NULL 
 END as copper_mg,
WHEN DR1ISODI IS NOT NULL THEN DR1ISODIWHEN DR1ISODI IS NULL THEN NULL 
ELSE NULL 
 END as sodium_mg,
WHEN DR1IPOTA IS NOT NULL THEN DR1IPOTAWHEN DR1IPOTA IS NULL THEN NULL 
ELSE NULL 
 END as potassium_mg,
WHEN DR1ISELE IS NOT NULL THEN DR1ISELEWHEN DR1ISELE IS NULL THEN NULL 
ELSE NULL 
 END as selenium_mcg,
WHEN DR1ICAFF IS NOT NULL THEN DR1ICAFFWHEN DR1ICAFF IS NULL THEN NULL 
ELSE NULL 
 END as caffeine_mg,
WHEN DR1ITHEO IS NOT NULL THEN DR1ITHEOWHEN DR1ITHEO IS NULL THEN NULL 
ELSE NULL 
 END as theobromine_mg,
WHEN DR1IALCO IS NOT NULL THEN DR1IALCOWHEN DR1IALCO IS NULL THEN NULL 
ELSE NULL 
 END as alcohol_gm,
WHEN DR1IMOIS IS NOT NULL THEN DR1IMOISWHEN DR1IMOIS IS NULL THEN NULL 
ELSE NULL 
 END as moisture_gm,
WHEN DR1IS040 IS NOT NULL THEN DR1IS040WHEN DR1IS040 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_4_0_butanoic_gm,
WHEN DR1IS060 IS NOT NULL THEN DR1IS060WHEN DR1IS060 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_6_0_hexanoic_gm,
WHEN DR1IS080 IS NOT NULL THEN DR1IS080WHEN DR1IS080 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_8_0_octanoic_gm,
WHEN DR1IS100 IS NOT NULL THEN DR1IS100WHEN DR1IS100 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_10_0_decanoic_gm,
WHEN DR1IS120 IS NOT NULL THEN DR1IS120WHEN DR1IS120 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_12_0_dodecanoic_gm,
WHEN DR1IS140 IS NOT NULL THEN DR1IS140WHEN DR1IS140 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_14_0_tetradecanoic_gm,
WHEN DR1IS160 IS NOT NULL THEN DR1IS160WHEN DR1IS160 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_16_0_hexadecanoic_gm,
WHEN DR1IS180 IS NOT NULL THEN DR1IS180WHEN DR1IS180 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_18_0_octadecanoic_gm,
WHEN DR1IM161 IS NOT NULL THEN DR1IM161WHEN DR1IM161 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_16_1_hexadecenoic_gm,
WHEN DR1IM181 IS NOT NULL THEN DR1IM181WHEN DR1IM181 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_18_1_octadecenoic_gm,
WHEN DR1IM201 IS NOT NULL THEN DR1IM201WHEN DR1IM201 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_20_1_eicosenoic_gm,
WHEN DR1IM221 IS NOT NULL THEN DR1IM221WHEN DR1IM221 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_22_1_docosenoic_gm,
WHEN DR1IP182 IS NOT NULL THEN DR1IP182WHEN DR1IP182 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_2_octadecadienoic_gm,
WHEN DR1IP183 IS NOT NULL THEN DR1IP183WHEN DR1IP183 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_3_octadecatrienoic_gm,
WHEN DR1IP184 IS NOT NULL THEN DR1IP184WHEN DR1IP184 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_4_octadecatetraenoic_gm,
WHEN DR1IP204 IS NOT NULL THEN DR1IP204WHEN DR1IP204 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_20_4_eicosatetraenoic_gm,
WHEN DR1IP205 IS NOT NULL THEN DR1IP205WHEN DR1IP205 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_20_5_eicosapentaenoic_gm,
WHEN DR1IP225 IS NOT NULL THEN DR1IP225WHEN DR1IP225 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_22_5_docosapentaenoic_gm,
WHEN DR1IP226 IS NOT NULL THEN DR1IP226WHEN DR1IP226 IS NULL THEN NULL 
ELSE NULL 
