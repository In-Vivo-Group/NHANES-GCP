...
WHEN SLQ300 = '99999' THEN 'Don't know' 
...
WHEN SLQ310 = '99999' THEN 'Don't know' 
WHEN SLQ310 IS NULL THEN NULL 
ELSE NULL 
 END as usual_wake_time_on_weekdays_or_workdays,
WHEN SLD012 IS NOT NULL THEN SAFE_CAST(SLD012 AS FLOAT64)WHEN SLD012 IS NULL THEN NULL 
ELSE NULL 
...
WHEN SLQ320 = '99999' THEN 'Don't know' 
...
WHEN SLQ330 = '99999' THEN 'Don't know' 
WHEN SLQ330 IS NULL THEN NULL 
ELSE NULL 
 END as usual_wake_time_on_weekends,
WHEN SLD013 IS NOT NULL THEN SAFE_CAST(SLD013 AS FLOAT64)WHEN SLD013 IS NULL THEN NULL 
ELSE NULL 
