...
WHEN DR1TNUMF IS NOT NULL THEN SAFE_CAST(DR1TNUMF AS FLOAT64)WHEN DR1TNUMF IS NULL THEN NULL 
ELSE NULL 
 END as number_of_foods_beverages_reported,
WHEN DR1TKCAL IS NOT NULL THEN SAFE_CAST(DR1TKCAL AS FLOAT64)WHEN DR1TKCAL IS NULL THEN NULL 
ELSE NULL 
 END as energy_kcal,
WHEN DR1TPROT IS NOT NULL THEN SAFE_CAST(DR1TPROT AS FLOAT64)WHEN DR1TPROT IS NULL THEN NULL 
ELSE NULL 
 END as protein_gm,
WHEN DR1TCARB IS NOT NULL THEN SAFE_CAST(DR1TCARB AS FLOAT64)WHEN DR1TCARB IS NULL THEN NULL 
ELSE NULL 
 END as carbohydrate_gm,
WHEN DR1TSUGR IS NOT NULL THEN SAFE_CAST(DR1TSUGR AS FLOAT64)WHEN DR1TSUGR IS NULL THEN NULL 
ELSE NULL 
 END as total_sugars_gm,
WHEN DR1TFIBE IS NOT NULL THEN SAFE_CAST(DR1TFIBE AS FLOAT64)WHEN DR1TFIBE IS NULL THEN NULL 
ELSE NULL 
 END as dietary_fiber_gm,
WHEN DR1TTFAT IS NOT NULL THEN SAFE_CAST(DR1TTFAT AS FLOAT64)WHEN DR1TTFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_fat_gm,
WHEN DR1TSFAT IS NOT NULL THEN SAFE_CAST(DR1TSFAT AS FLOAT64)WHEN DR1TSFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_saturated_fatty_acids_gm,
WHEN DR1TMFAT IS NOT NULL THEN SAFE_CAST(DR1TMFAT AS FLOAT64)WHEN DR1TMFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_monounsaturated_fatty_acids_gm,
WHEN DR1TPFAT IS NOT NULL THEN SAFE_CAST(DR1TPFAT AS FLOAT64)WHEN DR1TPFAT IS NULL THEN NULL 
ELSE NULL 
 END as total_polyunsaturated_fatty_acids_gm,
WHEN DR1TCHOL IS NOT NULL THEN SAFE_CAST(DR1TCHOL AS FLOAT64)WHEN DR1TCHOL IS NULL THEN NULL 
ELSE NULL 
 END as cholesterol_mg,
WHEN DR1TATOC IS NOT NULL THEN SAFE_CAST(DR1TATOC AS FLOAT64)WHEN DR1TATOC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_e_as_alpha_tocopherol_mg,
WHEN DR1TATOA IS NOT NULL THEN SAFE_CAST(DR1TATOA AS FLOAT64)WHEN DR1TATOA IS NULL THEN NULL 
ELSE NULL 
 END as added_alpha_tocopherol_vitamin_e_mg,
WHEN DR1TRET IS NOT NULL THEN SAFE_CAST(DR1TRET AS FLOAT64)WHEN DR1TRET IS NULL THEN NULL 
ELSE NULL 
 END as retinol_mcg,
WHEN DR1TVARA IS NOT NULL THEN SAFE_CAST(DR1TVARA AS FLOAT64)WHEN DR1TVARA IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_a_rae_mcg,
WHEN DR1TACAR IS NOT NULL THEN SAFE_CAST(DR1TACAR AS FLOAT64)WHEN DR1TACAR IS NULL THEN NULL 
ELSE NULL 
 END as alpha_carotene_mcg,
WHEN DR1TBCAR IS NOT NULL THEN SAFE_CAST(DR1TBCAR AS FLOAT64)WHEN DR1TBCAR IS NULL THEN NULL 
ELSE NULL 
 END as beta_carotene_mcg,
WHEN DR1TCRYP IS NOT NULL THEN SAFE_CAST(DR1TCRYP AS FLOAT64)WHEN DR1TCRYP IS NULL THEN NULL 
ELSE NULL 
 END as beta_cryptoxanthin_mcg,
WHEN DR1TLYCO IS NOT NULL THEN SAFE_CAST(DR1TLYCO AS FLOAT64)WHEN DR1TLYCO IS NULL THEN NULL 
ELSE NULL 
 END as lycopene_mcg,
WHEN DR1TLZ IS NOT NULL THEN SAFE_CAST(DR1TLZ AS FLOAT64)WHEN DR1TLZ IS NULL THEN NULL 
ELSE NULL 
 END as lutein_zeaxanthin_mcg,
WHEN DR1TVB1 IS NOT NULL THEN SAFE_CAST(DR1TVB1 AS FLOAT64)WHEN DR1TVB1 IS NULL THEN NULL 
ELSE NULL 
 END as thiamin_vitamin_b1_mg,
WHEN DR1TVB2 IS NOT NULL THEN SAFE_CAST(DR1TVB2 AS FLOAT64)WHEN DR1TVB2 IS NULL THEN NULL 
ELSE NULL 
 END as riboflavin_vitamin_b2_mg,
WHEN DR1TNIAC IS NOT NULL THEN SAFE_CAST(DR1TNIAC AS FLOAT64)WHEN DR1TNIAC IS NULL THEN NULL 
ELSE NULL 
 END as niacin_mg,
WHEN DR1TVB6 IS NOT NULL THEN SAFE_CAST(DR1TVB6 AS FLOAT64)WHEN DR1TVB6 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b6_mg,
WHEN DR1TFOLA IS NOT NULL THEN SAFE_CAST(DR1TFOLA AS FLOAT64)WHEN DR1TFOLA IS NULL THEN NULL 
ELSE NULL 
 END as total_folate_mcg,
WHEN DR1TFA IS NOT NULL THEN SAFE_CAST(DR1TFA AS FLOAT64)WHEN DR1TFA IS NULL THEN NULL 
ELSE NULL 
 END as folic_acid_mcg,
WHEN DR1TFF IS NOT NULL THEN SAFE_CAST(DR1TFF AS FLOAT64)WHEN DR1TFF IS NULL THEN NULL 
ELSE NULL 
 END as food_folate_mcg,
WHEN DR1TFDFE IS NOT NULL THEN SAFE_CAST(DR1TFDFE AS FLOAT64)WHEN DR1TFDFE IS NULL THEN NULL 
ELSE NULL 
 END as folate_dfe_mcg,
WHEN DR1TCHL IS NOT NULL THEN SAFE_CAST(DR1TCHL AS FLOAT64)WHEN DR1TCHL IS NULL THEN NULL 
ELSE NULL 
 END as total_choline_mg,
WHEN DR1TVB12 IS NOT NULL THEN SAFE_CAST(DR1TVB12 AS FLOAT64)WHEN DR1TVB12 IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_b12_mcg,
WHEN DR1TB12A IS NOT NULL THEN SAFE_CAST(DR1TB12A AS FLOAT64)WHEN DR1TB12A IS NULL THEN NULL 
ELSE NULL 
 END as added_vitamin_b12_mcg,
WHEN DR1TVC IS NOT NULL THEN SAFE_CAST(DR1TVC AS FLOAT64)WHEN DR1TVC IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_c_mg,
WHEN DR1TVD IS NOT NULL THEN SAFE_CAST(DR1TVD AS FLOAT64)WHEN DR1TVD IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_d_d2_d3_mcg,
WHEN DR1TVK IS NOT NULL THEN SAFE_CAST(DR1TVK AS FLOAT64)WHEN DR1TVK IS NULL THEN NULL 
ELSE NULL 
 END as vitamin_k_mcg,
WHEN DR1TCALC IS NOT NULL THEN SAFE_CAST(DR1TCALC AS FLOAT64)WHEN DR1TCALC IS NULL THEN NULL 
ELSE NULL 
 END as calcium_mg,
WHEN DR1TPHOS IS NOT NULL THEN SAFE_CAST(DR1TPHOS AS FLOAT64)WHEN DR1TPHOS IS NULL THEN NULL 
ELSE NULL 
 END as phosphorus_mg,
WHEN DR1TMAGN IS NOT NULL THEN SAFE_CAST(DR1TMAGN AS FLOAT64)WHEN DR1TMAGN IS NULL THEN NULL 
ELSE NULL 
 END as magnesium_mg,
WHEN DR1TIRON IS NOT NULL THEN SAFE_CAST(DR1TIRON AS FLOAT64)WHEN DR1TIRON IS NULL THEN NULL 
ELSE NULL 
 END as iron_mg,
WHEN DR1TZINC IS NOT NULL THEN SAFE_CAST(DR1TZINC AS FLOAT64)WHEN DR1TZINC IS NULL THEN NULL 
ELSE NULL 
 END as zinc_mg,
WHEN DR1TCOPP IS NOT NULL THEN SAFE_CAST(DR1TCOPP AS FLOAT64)WHEN DR1TCOPP IS NULL THEN NULL 
ELSE NULL 
 END as copper_mg,
WHEN DR1TSODI IS NOT NULL THEN SAFE_CAST(DR1TSODI AS FLOAT64)WHEN DR1TSODI IS NULL THEN NULL 
ELSE NULL 
 END as sodium_mg,
WHEN DR1TPOTA IS NOT NULL THEN SAFE_CAST(DR1TPOTA AS FLOAT64)WHEN DR1TPOTA IS NULL THEN NULL 
ELSE NULL 
 END as potassium_mg,
WHEN DR1TSELE IS NOT NULL THEN SAFE_CAST(DR1TSELE AS FLOAT64)WHEN DR1TSELE IS NULL THEN NULL 
ELSE NULL 
 END as selenium_mcg,
WHEN DR1TCAFF IS NOT NULL THEN SAFE_CAST(DR1TCAFF AS FLOAT64)WHEN DR1TCAFF IS NULL THEN NULL 
ELSE NULL 
 END as caffeine_mg,
WHEN DR1TTHEO IS NOT NULL THEN SAFE_CAST(DR1TTHEO AS FLOAT64)WHEN DR1TTHEO IS NULL THEN NULL 
ELSE NULL 
 END as theobromine_mg,
WHEN DR1TALCO IS NOT NULL THEN SAFE_CAST(DR1TALCO AS FLOAT64)WHEN DR1TALCO IS NULL THEN NULL 
ELSE NULL 
 END as alcohol_gm,
WHEN DR1TMOIS IS NOT NULL THEN SAFE_CAST(DR1TMOIS AS FLOAT64)WHEN DR1TMOIS IS NULL THEN NULL 
ELSE NULL 
 END as moisture_gm,
WHEN DR1TS040 IS NOT NULL THEN SAFE_CAST(DR1TS040 AS FLOAT64)WHEN DR1TS040 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_4_0_butanoic_gm,
WHEN DR1TS060 IS NOT NULL THEN SAFE_CAST(DR1TS060 AS FLOAT64)WHEN DR1TS060 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_6_0_hexanoic_gm,
WHEN DR1TS080 IS NOT NULL THEN SAFE_CAST(DR1TS080 AS FLOAT64)WHEN DR1TS080 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_8_0_octanoic_gm,
WHEN DR1TS100 IS NOT NULL THEN SAFE_CAST(DR1TS100 AS FLOAT64)WHEN DR1TS100 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_10_0_decanoic_gm,
WHEN DR1TS120 IS NOT NULL THEN SAFE_CAST(DR1TS120 AS FLOAT64)WHEN DR1TS120 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_12_0_dodecanoic_gm,
WHEN DR1TS140 IS NOT NULL THEN SAFE_CAST(DR1TS140 AS FLOAT64)WHEN DR1TS140 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_14_0_tetradecanoic_gm,
WHEN DR1TS160 IS NOT NULL THEN SAFE_CAST(DR1TS160 AS FLOAT64)WHEN DR1TS160 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_16_0_hexadecanoic_gm,
WHEN DR1TS180 IS NOT NULL THEN SAFE_CAST(DR1TS180 AS FLOAT64)WHEN DR1TS180 IS NULL THEN NULL 
ELSE NULL 
 END as sfa_18_0_octadecanoic_gm,
WHEN DR1TM161 IS NOT NULL THEN SAFE_CAST(DR1TM161 AS FLOAT64)WHEN DR1TM161 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_16_1_hexadecenoic_gm,
WHEN DR1TM181 IS NOT NULL THEN SAFE_CAST(DR1TM181 AS FLOAT64)WHEN DR1TM181 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_18_1_octadecenoic_gm,
WHEN DR1TM201 IS NOT NULL THEN SAFE_CAST(DR1TM201 AS FLOAT64)WHEN DR1TM201 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_20_1_eicosenoic_gm,
WHEN DR1TM221 IS NOT NULL THEN SAFE_CAST(DR1TM221 AS FLOAT64)WHEN DR1TM221 IS NULL THEN NULL 
ELSE NULL 
 END as mfa_22_1_docosenoic_gm,
WHEN DR1TP182 IS NOT NULL THEN SAFE_CAST(DR1TP182 AS FLOAT64)WHEN DR1TP182 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_2_octadecadienoic_gm,
WHEN DR1TP183 IS NOT NULL THEN SAFE_CAST(DR1TP183 AS FLOAT64)WHEN DR1TP183 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_3_octadecatrienoic_gm,
WHEN DR1TP184 IS NOT NULL THEN SAFE_CAST(DR1TP184 AS FLOAT64)WHEN DR1TP184 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_18_4_octadecatetraenoic_gm,
WHEN DR1TP204 IS NOT NULL THEN SAFE_CAST(DR1TP204 AS FLOAT64)WHEN DR1TP204 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_20_4_eicosatetraenoic_gm,
WHEN DR1TP205 IS NOT NULL THEN SAFE_CAST(DR1TP205 AS FLOAT64)WHEN DR1TP205 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_20_5_eicosapentaenoic_gm,
WHEN DR1TP225 IS NOT NULL THEN SAFE_CAST(DR1TP225 AS FLOAT64)WHEN DR1TP225 IS NULL THEN NULL 
ELSE NULL 
 END as pfa_22_5_docosapentaenoic_gm,
WHEN DR1TP226 IS NOT NULL THEN SAFE_CAST(DR1TP226 AS FLOAT64)WHEN DR1TP226 IS NULL THEN NULL 
ELSE NULL 
...
WHEN DR1_320Z IS NOT NULL THEN SAFE_CAST(DR1_320Z AS FLOAT64)WHEN DR1_320Z IS NULL THEN NULL 
ELSE NULL 
 END as total_plain_water_drank_yesterday_gm,
WHEN DR1_330Z IS NOT NULL THEN SAFE_CAST(DR1_330Z AS FLOAT64)WHEN DR1_330Z IS NULL THEN NULL 
ELSE NULL 
 END as total_tap_water_drank_yesterday_gm,
WHEN DR1BWATZ IS NOT NULL THEN SAFE_CAST(DR1BWATZ AS FLOAT64)WHEN DR1BWATZ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350AQ IS NOT NULL THEN SAFE_CAST(DRD350AQ AS FLOAT64)WHEN DRD350AQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350BQ IS NOT NULL THEN SAFE_CAST(DRD350BQ AS FLOAT64)WHEN DRD350BQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350CQ IS NOT NULL THEN SAFE_CAST(DRD350CQ AS FLOAT64)WHEN DRD350CQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350DQ IS NOT NULL THEN SAFE_CAST(DRD350DQ AS FLOAT64)WHEN DRD350DQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350EQ IS NOT NULL THEN SAFE_CAST(DRD350EQ AS FLOAT64)WHEN DRD350EQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350FQ IS NOT NULL THEN SAFE_CAST(DRD350FQ AS FLOAT64)WHEN DRD350FQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350GQ IS NOT NULL THEN SAFE_CAST(DRD350GQ AS FLOAT64)WHEN DRD350GQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350HQ IS NOT NULL THEN SAFE_CAST(DRD350HQ AS FLOAT64)WHEN DRD350HQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350IQ IS NOT NULL THEN SAFE_CAST(DRD350IQ AS FLOAT64)WHEN DRD350IQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD350JQ IS NOT NULL THEN SAFE_CAST(DRD350JQ AS FLOAT64)WHEN DRD350JQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370AQ IS NOT NULL THEN SAFE_CAST(DRD370AQ AS FLOAT64)WHEN DRD370AQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370BQ IS NOT NULL THEN SAFE_CAST(DRD370BQ AS FLOAT64)WHEN DRD370BQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370CQ IS NOT NULL THEN SAFE_CAST(DRD370CQ AS FLOAT64)WHEN DRD370CQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370DQ IS NOT NULL THEN SAFE_CAST(DRD370DQ AS FLOAT64)WHEN DRD370DQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370EQ IS NOT NULL THEN SAFE_CAST(DRD370EQ AS FLOAT64)WHEN DRD370EQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370FQ IS NOT NULL THEN SAFE_CAST(DRD370FQ AS FLOAT64)WHEN DRD370FQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370GQ IS NOT NULL THEN SAFE_CAST(DRD370GQ AS FLOAT64)WHEN DRD370GQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370HQ IS NOT NULL THEN SAFE_CAST(DRD370HQ AS FLOAT64)WHEN DRD370HQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370IQ IS NOT NULL THEN SAFE_CAST(DRD370IQ AS FLOAT64)WHEN DRD370IQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370JQ IS NOT NULL THEN SAFE_CAST(DRD370JQ AS FLOAT64)WHEN DRD370JQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370KQ IS NOT NULL THEN SAFE_CAST(DRD370KQ AS FLOAT64)WHEN DRD370KQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370LQ IS NOT NULL THEN SAFE_CAST(DRD370LQ AS FLOAT64)WHEN DRD370LQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370MQ IS NOT NULL THEN SAFE_CAST(DRD370MQ AS FLOAT64)WHEN DRD370MQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370NQ IS NOT NULL THEN SAFE_CAST(DRD370NQ AS FLOAT64)WHEN DRD370NQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370OQ IS NOT NULL THEN SAFE_CAST(DRD370OQ AS FLOAT64)WHEN DRD370OQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370PQ IS NOT NULL THEN SAFE_CAST(DRD370PQ AS FLOAT64)WHEN DRD370PQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370QQ IS NOT NULL THEN SAFE_CAST(DRD370QQ AS FLOAT64)WHEN DRD370QQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370RQ IS NOT NULL THEN SAFE_CAST(DRD370RQ AS FLOAT64)WHEN DRD370RQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370SQ IS NOT NULL THEN SAFE_CAST(DRD370SQ AS FLOAT64)WHEN DRD370SQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370TQ IS NOT NULL THEN SAFE_CAST(DRD370TQ AS FLOAT64)WHEN DRD370TQ IS NULL THEN NULL 
ELSE NULL 
...
WHEN DRD370UQ IS NOT NULL THEN SAFE_CAST(DRD370UQ AS FLOAT64)WHEN DRD370UQ IS NULL THEN NULL 
ELSE NULL 
