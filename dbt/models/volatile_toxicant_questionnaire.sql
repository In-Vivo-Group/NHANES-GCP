...
WHEN VTD241B IS NOT NULL THEN SAFE_CAST(VTD241B AS FLOAT64)WHEN VTD241B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD244B IS NOT NULL THEN SAFE_CAST(VTD244B AS FLOAT64)WHEN VTD244B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD251B IS NOT NULL THEN SAFE_CAST(VTD251B AS FLOAT64)WHEN VTD251B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD261B IS NOT NULL THEN SAFE_CAST(VTD261B AS FLOAT64)WHEN VTD261B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD271B IS NOT NULL THEN SAFE_CAST(VTD271B AS FLOAT64)WHEN VTD271B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD281B IS NOT NULL THEN SAFE_CAST(VTD281B AS FLOAT64)WHEN VTD281B IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD281D IS NOT NULL THEN SAFE_CAST(VTD281D AS FLOAT64)WHEN VTD281D IS NULL THEN NULL 
ELSE NULL 
...
WHEN VTD281F IS NOT NULL THEN SAFE_CAST(VTD281F AS FLOAT64)WHEN VTD281F IS NULL THEN NULL 
ELSE NULL 
