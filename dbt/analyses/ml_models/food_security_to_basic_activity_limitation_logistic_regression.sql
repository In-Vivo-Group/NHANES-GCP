CREATE OR REPLACE MODEL `nhanes.basic_activity_limitation_food_security_logistic_regression`
OPTIONS(model_type='LOGISTIC_REG', 
input_label_cols=['basic_activity_limitation'], 
...
AND b.getting_in_and_out_of_bed_difficulty IS NOT NULL
...
CASE
WHEN IFNULL(getting_in_and_out_of_bed_is_difficult,0) + IFNULL(using_fork_knife_drinking_from_cup_is_difficult,0) + 
IFNULL(dressing_yourself_is_difficult,0) + IFNULL(standing_for_long_periods_is_difficult,0) > 1 THEN 1
ELSE 0 END as basic_activity_limitation,
FROM initial_data;